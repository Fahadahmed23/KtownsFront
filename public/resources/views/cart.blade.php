            ...
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <div class="booking-left-content">
                        <table class="table table-bordered table-condensed book-detail-tbl">
                            <thead>
                                <tr>
                                    <th>ROOMS</th>
                                    <th>NO. OF ROOMS</th>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ url('details/'.$session['Slug']) }}"><img src="{{ url('resources/assets/web/img/edit-icon.png') }}" alt="*" class="img-fluid"></a>
                                             ...
                                             <button href="{{ url('remove-item/'.$session['HotelID']) }}" class="mr-2 delete_record" data-id="{{$session['HotelID']}}"> <img src="{{ url('resources/assets/web/img/delete-icon.png') }}" alt="*" class="img-fluid"></button>
                                        </td>
                                    </tr>
                                    <?php
                                }
