...
<section class="banner-form">
            ...
            <div class="col-lg-3">
                <div class="dcheck">
                    ...
                    <input type="text" name="daterange" value="" required="" />
           ...
           <!--  <div class="col-lg-3">
                          ...
                          <!-- <form class="px-4 py-3"> -->
                            <div class="form-group">
                              <label id="lblOccup" for="">Occupants</label>
                                    <div class="qty">
                                        ...
                                        <input type="number" class="countadult plusmiusbtns" name="adults" value="2" min=1>
                            ...
                            <!--<div class="form-group">
                              <label for="">Children</label>
                                    ...
                                    -->
                            <div class="form-group">
                              <label id="lblRoom" for="">Rooms</label>
                                    <div class="qty">
                                        <span class="minusroom bg-dark">-</span>
                                        <input type="number" class="countroom plusmiusbtns " name="rooms" value="1" min=1>
            ...
            <div class="col-lg-3">
                     <button type="button" class="btn-black m-auto d-table search-btn"><i class="icon-search"></i>Search now</a></button>
            </div>
