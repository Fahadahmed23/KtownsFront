                        ...
                        <div class="txtcol">
                            <div class="book-easy-form row">
                                <div class="form-group col-lg-6">
                                    ...
                                    {!! Form::text('FirstName', \Session::get('FirstName'), ['class' => 'form-control', 'id' => 'FirstName', 'required'=>'true']) !!}
                                </div>
                                <div class="form-group col-lg-6">
                                    <label>Last name <span class="text-danger">*</span></label>
                                    {!! Form::text('LastName', \Session::get('LastName'), ['class' => 'form-control', 'id' => 'LastName', 'required'=>'true']) !!}
                                </div>
                                <div class="form-group col-lg-6">
                                ...
                                <div class="form-group col-lg-6">
                                    ...
                                    <div class="input-group">
                                        ...
                                        {!! Form::text('Cell', \Session::get('Cell'), ['class' => 'form-control', 'id' => 'Cell' , 'placeholder'  => '3xx-xxxxxxx', 'required'=>'true']) !!}                                        
                                    </div>
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="inf-exp-left">
                ...
                <p><img src="{{ url('resources/assets/web') }}/img/loc-icon.png" alt="*"> <a style="cursor: pointer;" data-toggle="modal" data-target="#exampleModal1"><?php echo $details[0]->Address2; ?></a></p>
          </div>
        </div>
    </div>
</div>
<section class="exp-main-content">
    <!--<div class="container m-view d-lg-none d-md-none d-sm-block">
        <div class="col-12 booking-palet">
            <ul class="mb-0">
                <li>
                    <p><strong>Room type:</strong><span>Deluxe Twin Room</span></p>
                </li>
                <li><p>2 King size Bed <img src="https://www.ktownrooms.com/public/uploads/website/beds/kingbed.png" style="width: 24px;"> </p></li>
                <li>
                    <div class="d-flex r-m-facilities">
                        <div><img src="https://www.ktownrooms.com/public/uploads/website/services/7_uzOwz.png"></div>
                        <div><img src="https://www.ktownrooms.com/public/uploads/website/services/10_HHPr9.png"></div>
                        <div><img src="https://www.ktownrooms.com/public/uploads/website/services/7_uzOwz.png"></div>
                        <div><img src="https://www.ktownrooms.com/public/uploads/website/services/7_uzOwz.png"></div>
                        <div><img src="https://www.ktownrooms.com/public/uploads/website/services/7_uzOwz.png"></div>
                    </div>
                ...
                <li>
                    <div class="row">
                    <p class="col-5"><strong>Rooms</strong></p>
                    <div class="d-block col-7">
                        
                    <div class="qty d-flex" style="">
                        <span id="minus0" class="minusadult bg-dark">-</span>
                        <input id="ddOccupants0" type="text" readonly="" class="ml-auto countadult plusmiusbtns ddOccupants" name="occupants[]" data-capacity="2" data-maxallowed="3" data-additionalcharges="500.00" style="max-width:80px; width: auto;" min="0" max="9" value="2">
                        <span id="plus0" class="plusadult bg-dark">+</span>
                    </div></div></div>
                </li>
                <li>
                    <div class="check-time">
                        <p><strong>Check In/Out: </strong><span>12/03/2021 | 12/05/2021</span></p>
                    </div>
                </li>
                <li>
                    <p><strong>Price for 1 nights</strong><span>PKR 3,500</span></p>
                </li>
                <li>
                    <div class="slct-room col-12">
                        <div class="row">
                            <p class="col-4 pl-0"><strong>Rooms</strong></p>
                            <select class="mb-0 col-8 form-group NoOfRooms form-control" name="NoOfRooms[]">
                                <option value="0">Select</option>
                                <option value="1">1 PKR 3,500</option>
                                <option value="2">2 PKR 7,000</option>
                                <option value="3">3 PKR 10,500</option>
                                <option value="4">4 PKR 14,000</option>
                                <option value="5">5 PKR 17,500</option>
                            </select>
                        </div>
                    </div>
                </li>
                <li>
                    <p><strong>2</strong> Rooms for <strong>7000</strong></p>
                </li>
                <li>
                    <button class="btn btn-block btn-warning">Book Now</button>
                </li>
            </ul>
...
<script type="text/javascript">
    ...
    { 
        ...
        $('.plusadult').on('click', function(e) {
            ...
            let max = parseInt(ddOccupants.attr('data-maxallowed'));
        ...
        $('.btn-org').on('click', function(e){
            if ($('#Cell').val().replaceAll('-', '').replaceAll('_', '').replaceAll('(','').replaceAll(')','').length != 10) {
                $('#inputValidation h4').html('Error');
                $('#inputValidation #error_msg').html("Please Enter a Valid Phone Number");
       ...
       $('.exampleModal').click(function () {
        ...
        function calculateRoomPrice()
        {
            ...
            {
                // get the occupants dropdown

                if($('table tbody tr:eq('+i+') td:eq(6) select')[0] != undefined)
                {
                    sum += $('table tbody tr:eq('+i+') td:eq(6) select')[0].selectedIndex;
                    sumOfRooms += parseFloat($('table tbody tr:eq('+i+') td:eq(4) .spnPrice').text().replace(',','')) * $('table tbody tr:eq('+i+') td:eq(6) select')[0].selectedIndex;

                    // umer code
                    let ddOccupants = $('.ddOccupants:eq(' + i + ')');
                    ...
                    let rooms = $('table tbody tr:eq('+i+') td:eq(6) select')[0].selectedIndex;
                    ...
                    if (ddOccupants.val() > ddOccupants.attr('max')) {
                    ...
                    if ($('table tbody tr:eq('+i+') td:eq(6) select')[0].selectedIndex > 0) {
