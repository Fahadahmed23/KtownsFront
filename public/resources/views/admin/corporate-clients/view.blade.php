...
<html>
    <head>
        ...
        <title>{{ $configuration->WebsiteTitle }} | Corporate Partner Request</title>
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li><a href="{{ url('admin/corporate-clients') }}">Corporate Partner Requests</a></li>
                            ...
                            <div class="box box-primary">
                                <div class="box-header with-border">
                                    ...
                                    <div class="box-tools pull-right">
                                        <button type="button" class="btn btn-sm btn-warning" onclick="location.href = '{{ url('admin/corporate-clients') }}'"><i class="fa fa-times"></i> Back</button>
                                    </div>
                                </div>
                                <div class="box-body">
                                ...
                                <div class="box-footer">
                                    <div class="box-tools pull-right">
                                        <button type="button" class="btn btn-sm btn-warning hide" onclick="location.href = '{{ url('admin/corporate-clients') }}'"><i class="fa fa-times"></i> Back</button>
                                    </div>
                                </div>
                            </div>
                        </div>
