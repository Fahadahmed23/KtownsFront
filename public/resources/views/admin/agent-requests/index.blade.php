...
<html>
    <head>
        ...
        <title>{{ $configuration->WebsiteTitle }} | Agent Requests</title>
        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <h1><i class="fa fa-edit"></i> Agent Requests</h1>
                    <ol class="breadcrumb">
                ...
                <!-- Main content -->
                {!! Form::open([ 'url' => 'admin/agent-requests/delete', 'id' => 'frm_list' ]) !!}
                <section class="content">
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="box box-success">
                                <div class="box-header with-border">
                                    <h3 class="box-title">Agent Requests</h3>
