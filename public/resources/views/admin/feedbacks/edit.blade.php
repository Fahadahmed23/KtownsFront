...
<html>
    <head>
        ...
        <title>{{ $configuration->WebsiteTitle }} | Edit Feedback</title>
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li><a href="{{ url('admin/feedbacks') }}">Feedbacks</a></li>
                ...
                <section class="content">
                    {!! Form::open([ 'url' => 'admin/feedbacks/'.$feedback->FeedbackID]) !!}
                    <div class="row">
                        <div class="col-md-12">
                            <div class="box box-primary">
                                <div class="box-header with-border">
                                    ...
                                    <div class="box-tools pull-right">
                                        ...
                                        <button type="button" class="btn btn-sm btn-warning" onclick="location.href = '{{ url('admin/feedbacks') }}'"><i class="fa fa-times"></i> Cancel</button>
                                    </div>
                                </div>
                                <div class="box-body">
                                    <div class="row">
                                            ...
                                            <div class="box box-primary">
                                                ...
                                                <div class="box-body">
                                                    <div class="form-group">
                                                        <label for="Feedback">Feedback: <span class="mandatory">*</span></label>
                                                        {!! Form::textarea('Feedback', $feedback->Feedback, ['placeholder' => 'Enter Feedback', 'class' => 'form-control', 'id' => 'Feedback']) !!}
                                                    </div>
                                                </div>
                                            </div>
                                            <!-- /.box -->
                                            ...
                                            <div class="box box-primary">
                                                ...
                                                <div class="box-body">
                                                    <div class="form-group">
                                                        ...
                                                        {!! Form::select('Rating', $ratings, $feedback->Rating, ['class' => 'form-control', 'id' => 'Rating']) !!}
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="Status">Status</label><br>
                                                        <label>
                                                            {!! FORM::radio('Status', 1, ($feedback->Status == 1 ? true : null)) !!}
                                                            Active
                                                        </label>
                                                        <label>
                                                            {!! FORM::radio('Status', 0, ($feedback->Status == 0 ? true : null)) !!}
                                                            Deactive
                                                        </label>
                                                    </div>
