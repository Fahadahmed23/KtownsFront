...
<html>
    <head>
        ...
        <title>{{ $configuration->WebsiteTitle }} | Add New Promo Code</title>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                {!! Form::text('PromoCode', null, ['placeholder' => 'Enter Promo Code', 'class' => 'form-control', 'id' => 'PromoCode']) !!}
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                {!! Form::text('StartDate', null, ['placeholder' => 'Enter Start Date', 'class' => 'form-control', 'id' => 'StartDate']) !!}
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label for="EndDate">End Date: <span class="mandatory">*</span></label>
                                                                {!! Form::text('EndDate', null, ['placeholder' => 'Enter End Date', 'class' => 'form-control', 'id' => 'EndDate']) !!}
                                                            </div>
                                                        </div>
                                                    </div>
