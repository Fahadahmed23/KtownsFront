                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                {!! Form::text('AgreementStartDate', $hotel->AgreementStartDate, ['placeholder' => 'Enter Agreement Start Date', 'class' => 'form-control strtDate', 'id' => 'AgreementStartDate']) !!}
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label for="AgreementEndDate">Agreement End Date: <span class="mandatory">*</span></label>
                                                                {!! Form::text('AgreementEndDate', $hotel->AgreementEndDate, ['placeholder' => 'Enter Agreement End Date', 'class' => 'form-control endDate', 'id' => 'AgreementEndDate']) !!}
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                            ...
                                            <div class="box box-primary">
                                                ...
                                                <div class="box-body">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        {!! Form::select('SlugId', $slugid, $hotel->SlugId, ['class' => 'form-control', 'id' => 'SlugId']) !!}
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="HotelRoomType">Hotel Room Type: <span class="mandatory">*</span></label>
                                                        {!! Form::select('HotelRoomType', $hotelRoomtype, $hotel->hotel_room_type_id , ['class' => 'form-control', 'id' => 'HotelRoomType']) !!}
                                                    </div>
                                                    <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <label>
                                                            {!! FORM::radio('IsVisible', 1, ($hotel->IsVisible == 1 ? true : null)) !!}
                                                            Visible
                                                        </label>
                                                        <label>
                                                            {!! FORM::radio('IsVisible', 0, ($hotel->IsVisible == 0 ? true : null)) !!}
                                                            Not Visible
                                                        </label>
                                                    </div>
                                                </div>
