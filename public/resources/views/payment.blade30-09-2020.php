                            ...
                            <div class="termsNconditons">
                                ...
                                <div class="key-check" id="policy">
                                    ...
                                    <p> 
                                        ...
                                        <label>
                                            <input id="policy_terms" name="PrivacyCheckbox" type="checkbox" value="1" style="position: absolute; opacity: 0;">
                                            <span class="label-text"></span>
                                            <!-- <img src="{{ url('resources/assets/web/img/check-pay-icon.png') }}" alt="*" class="cp-icon"> -->
                                        </label>   
                                        <b ><p class="c-txt" style="color:#000;">I accept terms and conditions and general policy. <br></p></b>
                                </div>
