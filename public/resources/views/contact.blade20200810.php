    ...
    <div class="container align-self-center">
        <div class="row justify-content-center">
            <div class="col-lg-4 align-self-center mtpx-94">
                ...
                <div class="ad-box">
                    <h3>Phone</h3>
                    <p>{{ $configuration->Contact1 }}</p>
                    <p>{{ $configuration->Contact2 }}</p>
                </div>
                <div class="ad-box">
                    <h3>Email</h3>
                    <p>{{ $emails->SupportEmail }}</p>
                </div>
            ...
            <div class="col-lg-8">
                <div class="contact-box">
                    ...
                    {!! Form::open([ 'id' => 'frmLogin', 'url' => 'contact', 'class' => 'reg-form']) !!}
                    {!! Form::text('FirstName', null, ['id' => 'FirstName', 'placeholder' => 'First Name']) !!}  
                    {!! Form::text('LastName', null, ['id' => 'LastName', 'placeholder' => 'Last Name']) !!}
                    {!! Form::text('Email', null, ['id' => 'Email', 'placeholder' => 'Email Address']) !!}
                    {!! Form::text('Phone', null, ['id' => 'Phone', 'placeholder' => 'Contact']) !!}
