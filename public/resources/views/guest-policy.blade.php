...
@section('title', 'Ktown Rooms | Guest Policy') 
...
<!--<section class="d-flex vancies-banner bg-norepeat bg-center bg-cover" style="background:url({{ url('resources/assets/web') }}/img/banners/vacancies-bg.jpg);">
    ...
    <div class="container align-self-center">
        <div class="row justify-content-center">
            <div class="col-lg-12">
                <h2 class="ban-heading wow fadeInDown animated">GUEST POLICY
...
<section class="vac-main ptpx-0 pbpx-30">
    <div class="container align-self-center">
        ...
        <div class="col-md-12">
            ...
            <!--    <li>Further, KTown Rooms shall not be held responsible for non-availability of the Website/ Application during periodic maintenance operations or any unplanned suspension of access to the Website/ Application that may occur due to technical reasons or for any reasons beyond KTown Rooms’ control.</li>-->
            <!--    <li>Guest must use his own credit/debit card for any payments to KTown Rooms website or in KTown Rooms partner hotels. The KTown rooms shall not be liable for any credit/debit card fraud. The liability to use a card fraudulently would be on the guest and the onus to ‘prove otherwise’ shall be exclusively on guest.</li>-->
            <!--    <li>The User agrees, acknowledges and confirms that before placing any order, the User shall check the Service description and price carefully and by placing an order for a Service You agree to be bound by the Usage Terms and conditions of sale included in the Services’ description. You shall only place the order after fully satisfying yourself with the price, description, look as has been displayed on KTown Rooms Website/Application.</li>-->
            <!--    <li>KTown Rooms shall not be responsible and shall not be required to mediate or resolve any dispute or disagreement between User and Channel Partner. In no event, shall KTown Rooms be made a party to dispute between User(s) and Channel Partner(s).</li>-->
            <!--    <li>Your use of the Services shall be deemed that you are fully satisfied with the description, look and design of the accommodation and usage fee of the Accommodation as has been displayed on Ktown Room's Website/ Application.</li>-->
            <!--    <li>Ktown Rooms makes the services available to user through the website only if user provide Ktown Rooms required User information through creating an account (“Account”) Via&nbsp; Ktown Rooms ID and Password or other log-in ID and Password (collectively, the “Account Information”). We only provide you services once you register as a User, and the sole responsibility of maintaining confidentiality of the account information on You (User). We “Ktown Rooms” shall not be liable for any loss or damage done due to lack of confidentiality of Account information.</li>-->
            <!--    <li>The Services are provided by Ktown Rooms on an "as is" basis without warranty of any kind, to User.</li>-->
            <!--    <li>These terms will be interpreted in accordance with the laws of the Pakistan. You (User) and we (KTown Rooms) agree to submit to the exclusive jurisdiction of a court located in Karachi for any dispute, claim or actions in relation to these terms or the use of services provided through ktownrooms.com</li>-->
            <!--</ul>-->
