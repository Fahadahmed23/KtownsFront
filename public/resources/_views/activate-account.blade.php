...
<html>
    <head>
        ...
        <title>{{ $configuration->WebsiteTitle }} | Activate Account</title>
                ...
                <div class="row">
                    <div class="col-md-4 col-md-offset-4 col-sm-6 col-sm-offset-3">
                        <div id="login">
                            ...
                            {!! Form::open([ 'id' => 'frmLogin', 'url' => 'activate-account']) !!}
                            <div class="form-group">
                                
                                <label>Activation Code</label>
                                {!! Form::text('ActivationCode', null, ['class' => 'form-control', 'id' => 'ActivationCode', 'placeholder' => 'Activation Code']) !!}
                                <label>{!! $my_msg !!}</label>
                            </div>
