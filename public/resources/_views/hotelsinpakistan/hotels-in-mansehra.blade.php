...
<html>
    <head>
        ...
        <title>Hotels in Mansehra | Guest House In Mansehra | Ktown Rooms</title>
        <meta name="description" content="Book a hotels in Mansehra, get the best hotels and guest house deals in Mansehra with the facilities of Free WiFi, free breakfast, AC, 32″ LED in a room.">
        <!-- Favicons-->
    ...
    <body>
        ...
        <section class="parallax-window" data-parallax="scroll" data-image-src="{{ url('resources/assets/web') }}/img/covers/mansehra-cover.png" data-natural-width="1400" data-natural-height="470">
            <div class="parallax-content-1">
                <div class="animated fadeInDown">
                    <h1>Mansehra Top Hotels</h1>
        ...
        <div  class="container margin_60">
            ...
            <div class="row">
                ...
                <div class="col-lg-9 col-md-9">
                    <div>
                        <h1 style="margin-top:0px;">HOTELS IN MANSEHRA</h1>
                        <p>Mansehra is a city that belongs to Khyber Pakhtunkhwa. The word Mansehra is a Hindi word "Mahaan Sehra" meaning 'flowers in abundance'. It is considered to the most beautiful cities in Pakistan and is known as Paradise on Earth with beautiful scenery and greenery. The place was considered International tourism spot before but due to some security issues ratio of international tourism has decreased.<span id="dots">...</span></p>
                        <div id="more">
                            <p>Makra crest is a Himalayan mountain that is situated at a distance of around 70 km from Mansehra. It is covered with snow in a spider web pattern, after which it is named as Makra. Travelers trek for 5 hours and reach the highest point of the mountain, Makra top. The travelers can enjoy the enchanting view from the Kaghan Valley on one side and exciting Kashmir on another from the top.</p>
                            <p>Mansehra is a beautiful place with natural beauty. Everyone knows about Naran, Kaghan, Lala Zar, Shogran, Balakot and so on, however there are more must visit places like Kund Bangla, Darband, Siri, Siran Valley, Pakhal Valley, Konsh valley.
                    ...
                    ?>
                    <hr>
                    <!--<img src="{{ url('public/uploads/website/hotels/hotels-in-mansehra/upper-channai.png') }}">
                    <hr>
                    <img src="{{ url('public/uploads/website/hotels/hotels-in-mansehra/hussainabad.png') }}">
                    <hr>
                    <img src="{{ url('public/uploads/website/hotels/hotels-in-mansehra/new-city.png') }}">-->
                </div>
            </div>
        </div>
