...
<html>
    <head>
        ...
        <title>Hotels in Saidu Sharif | Guest House In Saidu Sharif | Ktown Rooms</title>
        <meta name="description" content="Book a hotels in Saidu Sharif, get the best hotels and guest house deals in Saidu Sharif with the facilities of Free WiFi, free breakfast, AC, 32″ LED in a room.">
        <!-- Favicons-->
    ...
    <body>
        ...
        <section class="parallax-window" data-parallax="scroll" data-image-src="{{ url('resources/assets/web') }}/img/covers/saidu-sharif-cover.jpg" data-natural-width="1400" data-natural-height="470">
            <div class="parallax-content-1">
                <div class="animated fadeInDown">
                    <h1>Saidu Sharif Top Hotels</h1>
        ...
        <div  class="container margin_60">
            ...
            <div class="row">
                ...
                <div class="col-lg-9 col-md-9">
                    <div>
                        <h1 style="margin-top:0px;">HOTELS IN SAIDU SHARIF</h1>
                        <p>Saidu Sharif is the capital of Swat and it is the second largest city after Mingora in Swat. It is the hub of the major buildings such as Swat museum, tomb of Saidu Baba, Royal Residential palace, Jahzaib College (Government Degree College) as well as commissioner house. This city was previously known as “Baligram.”  Weather of is quite mild and pleasant which is ideal for any trip. This is a perfect spot for picnics as there is simply greenery all around.  There are spots to remain here, where one can truly appreciate the beautiful magnificence of Swat.</p>
                        <p>Ktown Rooms has mentioned must-visit attractions of Saidu Sharif in this description to give you a quick look on two of themust-visit places in Saidu Sharif.<span id="dots">...</span></p>
                           <div id="more">
                               <ul style="list-style: none;">
                                   <li>
                                       <strong>Swat Museum</strong><br>
                                        <p>This Swat Museum had been furnished by Japan, to improve and increase the collection. There are collections of Gandhara models taken by Buddhist destinations in Swat, illustrating Buddha's biography. Also there are utensils, valuable stones, weapons and so forth from the Gandhara collection.</p>
                                   </li>
                                   <li>
                                    <strong>Saidu Sharif Stupa</strong><br>
                                    <p>The Saidu Sharif Stupa, uncovered under the name Saidu Sharif, It is a holy territory of Buddhist situated close to the city of Saidu Sharif, at the foot of the mountains that divide the river Saidu from river Jambil in Swat. It is considered to be the must visit place.</p>
                                    <p>Ktown Rooms offers its hospitality services in this city to make these must visit attractions near to your hotel in Saidu Sharifwith complete amenities, Air conditioners, 32” LED and a lot more. Their hotels are the cheapest hotels in Saidu Sharif with standardized services.</p>
                                   </li>
                               </ul>
                           </div>
                    ...
                    ?>
                    <hr>
                    <!--<img src="{{ url('public/uploads/website/hotels/hotels-in-saidu-sharif/officer-colony.png') }}">
                    <hr>
                    <img src="{{ url('public/uploads/website/hotels/hotels-in-saidu-sharif/swat-serena.png') }}">
                    <hr>
                    <img src="{{ url('public/uploads/website/hotels/hotels-in-saidu-sharif/makan-bagh.png') }}">-->
                </div>
            </div>
        </div>
