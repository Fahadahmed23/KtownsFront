...
<html>
    <head>
        ...
        <title>Hotels in Arang Kel | Guest House In Arang Kel | Ktown Rooms</title>
        <meta name="description" content="Book a hotels in Arang Kel, get the best hotels and guest house deals in Arang Kel with the facilities of Free WiFi, free breakfast, AC, 32″ LED in a room.">
        <!-- Favicons-->
    ...
    <body>
        ...
        <section class="parallax-window" data-parallax="scroll" data-image-src="{{ url('resources/assets/web') }}/img/covers/arang-kel-cover.jpg" data-natural-width="1400" data-natural-height="470">
            <div class="parallax-content-1">
                <div class="animated fadeInDown">
                    <h1>Arang Kel Top Hotels</h1>
        ...
        <div  class="container margin_60">
            ...
            <div class="row">
                ...
                <div class="col-lg-9 col-md-9">
                    ...
                    ?>
                    <hr>
                    <!--<img src="{{ url('public/uploads/website/hotels/hotels-in-arang-kel/kel-sari.png') }}">
                    <hr>
                    <img src="{{ url('public/uploads/website/hotels/hotels-in-arang-kel/arrang-kel.png') }}">
                    <hr>
                    <img src="{{ url('public/uploads/website/hotels/hotels-in-arang-kel/arang-kel.png') }}">-->
                </div>
            </div>
        </div>
