...
<html>
    <head>
        ...
        <title>Hotels in Hunza | Guest House In Hunza | Ktown Rooms</title>
    ...
    <body>
        ...
        <section class="parallax-window" data-parallax="scroll" data-image-src="{{ url('resources/assets/web') }}/img/covers/hunza-cover.jpg" data-natural-width="1400" data-natural-height="470">
            <div class="parallax-content-1">
                <div class="animated fadeInDown">
                    <h1>Hunza Top Hotels</h1>
        ...
        <div  class="container margin_60">
            ...
            <div class="row">
                ...
                <div class="col-lg-9 col-md-9">
                        ...
                        <p>Hunza Valley is situated in Gilgit, this valley is famous for its beauty, and residents of Hunza are also famous for their hospitality nature and kindness. Tourists usually visit this city between May and October as the roads are usually blocked by the snow. Famous foods in Hunza are Sharbat, diram-fete, davado, muleda; however, all these things are prepared on special occasion. It is also known for traditional dishes that are served at the restaurants in Karimabad market where people eat after shopping, there are like more than 50 shops. One of the must visit attractions in this area is the minerals and gemstones, those who love to collect things they must visit this place. Ktown Rooms has gathered all the must visit attractions at one place.<span id="dots">...</span></p>
                           <div id="more">
                               <ul style="list-style: none;">
                                   ...
                                   <li>
                                       <strong>3. Trekking</strong><br>
                                        <p>Hunza valley is popular for its trekking; moreover, the most popular peak K2, is also situated in the Gilgit-Baldistan. There are different trekking spots which travelers must visit when they plan for Hunza Valley.</p>
                    ...
                    ?>
                    <hr>
                    <!--<img src="{{ url('public/uploads/website/hotels/hotels-in-hunza/karimabad-road.png') }}">
                    <hr>
                    <img src="{{ url('public/uploads/website/hotels/hotels-in-hunza/upper-link-road.png') }}">
                    <hr>
                    <img src="{{ url('public/uploads/website/hotels/hotels-in-hunza/eagles-nest.png') }}">-->
                </div>
            </div>
        </div>
