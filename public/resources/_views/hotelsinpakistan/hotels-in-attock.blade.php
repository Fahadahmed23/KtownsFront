...
<html>
    <head>
        ...
        <title>Hotels in Attock | Guest House In Attock | Ktown Rooms</title>
        <meta name="description" content="Book a hotels in Attock, get the best hotels and guest house deals in Attock with the facilities of Free WiFi, free breakfast, AC, 32″ LED in a room.">
        <!-- Favicons-->
    ...
    <body>
        ...
        <section class="parallax-window" data-parallax="scroll" data-image-src="{{ url('resources/assets/web') }}/img/covers/attock-cover.png" data-natural-width="1400" data-natural-height="470">
            <div class="parallax-content-1">
                <div class="animated fadeInDown">
                    <h1>Attock Top Hotels</h1>
        ...
        <div  class="container margin_60">
            ...
            <div class="row">
                ...
                <div class="col-lg-9 col-md-9">
                    ...
                    ?>
                    <hr>
                    <!--<img src="{{ url('public/uploads/website/hotels/hotels-in-attock/dar-ul-salam.png') }}">
                    <hr>
                    <img src="{{ url('public/uploads/website/hotels/hotels-in-attock/stadium-road.png') }}">-->
                </div>
            </div>
        </div>
