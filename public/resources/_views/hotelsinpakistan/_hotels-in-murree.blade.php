...
<html>
    <head>
        ...
        <title>Hotels in Murree| Guest House In Murree | Ktown Rooms</title>
        <meta name="description" content="Book a hotels in Murree, get the best hotels and guest house deals in Murree with the facilities of Free WiFi, free breakfast, AC, 32″ LED in a room.">
        <!-- Favicons-->
    ...
    <body>
        ...
        <section class="parallax-window" data-parallax="scroll" data-image-src="{{ url('resources/assets/web') }}/img/covers/murree-cover.jpg" data-natural-width="1400" data-natural-height="470">
            <div class="parallax-content-1">
                <div class="animated fadeInDown">
                    <h1>Murree Top Hotels</h1>
        ...
        <div  class="container margin_60">
            ...
            <div class="row">
                ...
                <div class="col-lg-9 col-md-9">
                         ...
                         <p>There are several beautiful places to visit in Muree, most visited places in Muree by the tourists are Nathia Gali and Mall road that keep people engaged with its beauty, and peaceful atmosphere. Another undeniable fact about Muree is that the weather never gets too hot. The coastal climate does wonders for the temperature and the constant breeze is a blessing for visitors. While people in all other cities are bearing heat wave, people in Muree enjoys pleasant weather. The fact that there are so many peaceful places accessible to Muree makes it one of the most important reasons why you should visit Muree. To increase tourism they have offered several cheap hotels, 3 star hotels and guest houses in Muree to make you spend fewer amounts on your accommodation.<span id="dots">...</span></p>
                           <div id="more">
                               <ul style="list-style: none;">
                                   <li>
                                       <strong>1. Food Street</strong><br>
                                        <p>Of course, how can we forget to mention about food. We know that another Pakistani city supposedly has a name for being the best food street in the country, but the reality is far from it. There are people from different backgrounds and different cultures who come to visit Muree. It has several places where you can eat classic desi food like biryani, chaat, and tikka. The amount of delicious food you can get in Muree is truly unbelievable.</p>
                                   </li>
                                   <li>
                                    <strong>2. Numerous Shops</strong><br>
                                   ...
                                   <li>
                                       <strong>3. Secured Guest houses</strong><br>
                    ...
                    <img src="{{ url('public/uploads/website/hotels/hotels-in-murree/nathiagali.png') }}">
                    <hr>
                    <img src="{{ url('public/uploads/website/hotels/hotels-in-murree/mallroad.png') }}">
                    <hr>
                    <img src="{{ url('public/uploads/website/hotels/hotels-in-murree/ayubia.png') }}">
                </div>
            </div>
        </div>
