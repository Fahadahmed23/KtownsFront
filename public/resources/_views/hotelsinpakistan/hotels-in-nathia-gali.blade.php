...
<html>
    <head>
        ...
        <title>Hotels in Nathia Gali | Guest House In Nathia Gali | Ktown Rooms</title>
        <meta name="description" content="Book a hotels in Nathia Gali, get the best hotels and guest house deals in Nathia Gali with the facilities of Free WiFi, free breakfast, AC, 32″ LED in a room.">
        <!-- Favicons-->
    ...
    <body>
        ...
        <section class="parallax-window" data-parallax="scroll" data-image-src="{{ url('resources/assets/web') }}/img/covers/nathia-gali-cover.png" data-natural-width="1400" data-natural-height="470">
            <div class="parallax-content-1">
                <div class="animated fadeInDown">
                    <h1>Nathia Gali Top Hotels</h1>
        ...
        <div  class="container margin_60">
            ...
            <div class="row">
                ...
                <div class="col-lg-9 col-md-9">
                    <div>
                        <h1 style="margin-top:0px;">HOTELS IN NATHIA GALI</h1>
                        <p>Nathia Gali is a mountain resort, situated in Hazara, Khyber Pakhtunkhwa. It is around one hour drive away from both Murree and Abbottabad and is one of the famous hill stations.</p>
                    ...
                    ?>
                    <hr>
                    <!--<img src="{{ url('public/uploads/website/hotels/hotels-in-nathia-gali/opp-sui-gas.png') }}">
                    <hr>
                    <img src="{{ url('public/uploads/website/hotels/hotels-in-nathia-gali/main-bazaar.png') }}">
                    <hr>
                    <img src="{{ url('public/uploads/website/hotels/hotels-in-nathia-gali/children-park.png') }}">-->
                </div>
            </div>
        </div>
