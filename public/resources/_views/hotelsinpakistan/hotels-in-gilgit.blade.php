...
<html>
    <head>
        ...
        <title>Hotels in Gilgit | Guest House In Gilgit | Ktown Rooms</title>
        <meta name="description" content="Book a hotels in Gilgit, get the best hotels and guest house deals in Gilgit with the facilities of Free WiFi, free breakfast, AC, 32″ LED in a room.">
        <!-- Favicons-->
    ...
    <body>
        ...
        <section class="parallax-window" data-parallax="scroll" data-image-src="{{ url('resources/assets/web') }}/img/covers/gilgit-cover.jpg" data-natural-width="1400" data-natural-height="470">
            <div class="parallax-content-1">
                <div class="animated fadeInDown">
                    <h1>Gilgit Top Hotels</h1>
        ...
        <div  class="container margin_60">
            ...
            <div class="row">
                ...
                <div class="col-lg-9 col-md-9">
                    <div>
                        <h1 style="margin-top:0px;">HOTELS IN GILGIT</h1>
                        <p>KTown Rooms allow travelers to book instantly from 10 hotels in Gilgit, as per their choice. If you want an online hotel booking of budget hotels in any specific category. KTown rooms offer dedicated elite class budget hotels for business travelers in Gilgit, however ktown isn’t couple friendly hotel or don’t provide hotels for dates/ or rooms for unmarried couples in Gilgit.</p>
                    </div>
                    <?php
                    if (isset($hotels)) {
                    if (count($hotels) > 0) {
                    ...
                    ?>
                    <hr>
                    <!--<img src="{{ url('public/uploads/website/hotels/hotels-in-gilgit/babar-road.png') }}">
                    <hr>
                    <img src="{{ url('public/uploads/website/hotels/hotels-in-gilgit/sherullah-baig.png') }}">
                    <hr>
                    <img src="{{ url('public/uploads/website/hotels/hotels-in-gilgit/airport-road.png') }}">-->
                </div>
            </div>
        </div>
