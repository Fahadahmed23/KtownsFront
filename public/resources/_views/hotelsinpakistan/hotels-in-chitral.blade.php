...
<html>
    <head>
        ...
        <title>Hotels in Chitral | Guest House In Chitral | Ktown Rooms</title>
        <meta name="description" content="Book a hotels in Chitral, get the best hotels and guest house deals in Chitral with the facilities of Free WiFi, free breakfast, AC, 32″ LED in a room.">
        <!-- Favicons-->
    ...
    <body>
        ...
        <section class="parallax-window" data-parallax="scroll" data-image-src="{{ url('resources/assets/web') }}/img/covers/chitral-cover.png" data-natural-width="1400" data-natural-height="470">
            <div class="parallax-content-1">
                <div class="animated fadeInDown">
                    <h1>Chitral Top Hotels</h1>
        ...
        <div  class="container margin_60">
            ...
            <div class="row">
                ...
                <div class="col-lg-9 col-md-9">
                    <div>
                        <h1 style="margin-top:0px;">HOTELS IN CHITRAL</h1>
                    ...
                    <!--<img src="{{ url('public/uploads/website/hotels/hotels-in-chitral/shahi-masjid.png') }}">
                    <hr>
                    <img src="{{ url('public/uploads/website/hotels/hotels-in-chitral/hindu-kush-heights.png') }}">
                    <hr>
                    <img src="{{ url('public/uploads/website/hotels/hotels-in-chitral/chitral-kpk.png') }}">-->
                    <?php
                    if (count($hotels) > 0) {
