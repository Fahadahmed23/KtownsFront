...
<html>
    <head>
        ...
        <title>Hotels in Bahawalpur | Guest House In Bahawalpur | Ktown Rooms</title>
        <meta name="description" content="Book a hotels in Bahawalpur, get the best hotels and guest house deals in Bahawalpur with the facilities of Free WiFi, free breakfast, AC, 32″ LED in a room.">
        <!-- Favicons-->
    ...
    <body>
        ...
        <section class="parallax-window" data-parallax="scroll" data-image-src="{{ url('resources/assets/web') }}/img/covers/bahawalpur-cover.jpg" data-natural-width="1400" data-natural-height="470">
            <div class="parallax-content-1">
                <div class="animated fadeInDown">
                    <h1>Bahawalpur Top Hotels</h1>
        ...
        <div  class="container margin_60">
            ...
            <div class="row">
                ...
                <div class="col-lg-9 col-md-9">
                    <div>
                        <h1 style="margin-top:0px;">HOTELS IN BAHAWALPUR</h1>
                        <p>Bhawalpur is a city situated in the Punjab area of Pakistan. Bahawalpur is the twelfth biggest city in Pakistan with a population of 798,509. The city lies close to the Derawar Fort in Cholistan close to the India’s border, and a gateway to Lal Suhanra National Park. The temperature here is like "desert." As there is no rainfall and the normal yearly temperature is 25.7 °C in Bahawalpur.</p>
                        <p>Ktown Rooms has put together two must visit attractions in Bahawalpur so that tourists do not miss out these amazing places.<span id="dots">...</span></p>
                           <div id="more">
                               <ul style="list-style: none;">
                                   <li>
                                       <strong>1. Derawar Fort</strong><br>
                                        <p>Derawar Fort is found 100 kilometers (62 miles) from Bahawalpur. This fortification is the biggest and most greatly supported stronghold of Cholistan. The entrance of fort is on its southern, this fort or semi desert is viewed from miles around.</p>
                                        <p>Inside Derawar Fort various quarters have been given to Nawab's military. Quarters of the regal family standing inside the fortress are changing into dust. There are holy places of four devout Muslims close to Derawar Fort. The Derawar Mosque having four minaretsand dome is an imitation of Moti Mosque at Red Fort Dehli.</p>
                                   </li>
                                   <li>
                                    <strong>2. Noor Mahal</strong><br>
                                    <p>Noor Mahal is constructed in 1875 AD, this mahal is almost one hundred and fifty years, and, is the latest landmark in Punjab to be called Antiquities Act. Pakistan Army took liability of this mahal in 1999 and helped to reestablished and save the structure into its original shape. The structure was announced as a "proctected monument."  Department of Archeology is in charge to preserve this mahal and they have opened it for public, students, delegates, guests, and tourists from different countries.</p>
                    ...
                    ?>
                    <hr>
                    <!--<img src="{{ url('public/uploads/website/hotels/hotels-in-bahawalpur/near-green-market.png') }}">
                    <hr>
                    <img src="{{ url('public/uploads/website/hotels/hotels-in-bahawalpur/one-unit-chowk.png') }}">
                    <hr>
                    <img src="{{ url('public/uploads/website/hotels/hotels-in-bahawalpur/yazman-road.png') }}">-->
                </div>
            </div>
        </div>
