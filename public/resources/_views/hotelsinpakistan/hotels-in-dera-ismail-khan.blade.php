...
<html>
    <head>
        ...
        <title>Hotels in Dera Ismail Khan | Guest House In Dera Ismail Khan | Ktown Rooms</title>
        <meta name="description" content="Book a hotels in Dera Ismail Khan, get the best hotels and guest house deals in Dera Ismail Khan with the facilities of Free WiFi, free breakfast, AC, 32″ LED in a room." />
        <!-- Favicons-->
    ...
    <body>
        ...
        <section class="parallax-window" data-parallax="scroll" data-image-src="{{ url('resources/assets/web') }}/img/covers/dera-ismail-khan-cover.jpg" data-natural-width="1400" data-natural-height="470">
            <div class="parallax-content-1">
                <div class="animated fadeInDown">
                    <h1>Dera Ismail Khan Top Hotels</h1>
        ...
        <div  class="container margin_60">
            ...
            <div class="row">
                ...
                <div class="col-lg-9 col-md-9">
                    <div>
                        <h1 style="margin-top:0px;">HOTELS IN DERA ISMAIL KHAN</h1>
                        <p>Dera Ismail Khan, normally abbreviated to D.I. Khan, is a town in Khyber-Pakhtunkhwa Province, Pakistan. It is situated on the West Bank of the Indus River, three hundred and twenty kilometers west of Lahore and a hundred and ninety kilometers northwest of Multan. Dera Ismail Khan’s weather is extremely hot in summers and mild cold in winters.<span id="dots">...</span></p>
                        <div id="more">
                            <p>In spite of the fact that town is relatively new, reconstructed after 1823 flood, a few of its original structure remained as it is. Place to visit is an Islamic place known as Bilot, forty eight kilometers from the Dera Ismail Khan.</p>
                            <p>If you are traveling far away from your city for vacations or for a work, you would definitely need a place to stay in Dera Ismail Khan. For this purpose, Ktown Rooms has developed their cheap hotels and guest houses in Dera Ismail Khan.</p>
                        </div>
                    ...
                    ?>
                    <hr>
                    <!--<img src="{{ url('public/uploads/website/hotels/hotels-in-dera-ismail-khan/gpo-chowk.png') }}">
                    <hr>
                    <img src="{{ url('public/uploads/website/hotels/hotels-in-dera-ismail-khan/east-circular.png') }}">
                    <hr>
                    <img src="{{ url('public/uploads/website/hotels/hotels-in-dera-ismail-khan/indus-river.png') }}">-->
                </div>
            </div>
        </div>
