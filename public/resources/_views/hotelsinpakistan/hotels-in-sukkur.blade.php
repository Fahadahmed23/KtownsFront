...
<html>
    <head>
        ...
        <title>Hotels in Sukkur | Guest House In Sukkur | Ktown Rooms</title>
        <meta name="description" content="Book a hotels in Sukkur, get the best hotels and guest house deals in Sukkur with the facilities of Free WiFi, free breakfast, AC, 32″ LED in a room.">
        <!-- Favicons-->
    ...
    <body>
        ...
        <section class="parallax-window" data-parallax="scroll" data-image-src="{{ url('resources/assets/web') }}/img/covers/sukkur-cover.jpg" data-natural-width="1400" data-natural-height="470">
            <div class="parallax-content-1">
                <div class="animated fadeInDown">
                    <h1>Sukkur Top Hotels</h1>
        ...
        <div  class="container margin_60">
            ...
            <div class="row">
                ...
                <div class="col-lg-9 col-md-9">
                        ...
                        <p>Sukkur is decent yet delightful; the weather of Sukkur is generally hot, and dry. The city is delightfully constructed so that tourists can't quit traveling to Sukkur and exploring the wonderfulness of this city. To make your stay comfortable, book your room in hotels near to airport, or a guest house in Sukkur.<span id="dots">...</span></p>
                           <div id="more">
                               <ul style="list-style: none;">
                                   ...
                                   <li>
                                    <strong>2. Sukkur Barrage</strong><br>
                                    <p>Sukkur barrage (flyover) is situated close to Sukkur city. There are around 66 parts of the barrage and they all have a gateway (weight 50 tons), to control the water stream for cultivation, harvesting and floods.</p>
                                   </li>
                                   <li>
                                       <strong>3. Lab-e–Mehran</strong><br>
                                        <p>Lab-e-Mehran is a attractive garden situated in Sukkur. Garden is attractive and nearby Indus River. The garden has various facilities, for instance, separate family hall, hotel, boating and more.</p>
                    ...
                    ?>
                    <hr>
                    <!--<img src="{{ url('public/uploads/website/hotels/hotels-in-sukkur/militoryroad.png') }}">
                    <hr>
                    <img src="{{ url('public/uploads/website/hotels/hotels-in-sukkur/workshop.png') }}">
                    <hr>
                    <img src="{{ url('public/uploads/website/hotels/hotels-in-sukkur/airport.png') }}">-->
                </div>
            </div>
        </div>
