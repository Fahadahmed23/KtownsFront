...
//                                }
                        ...
                        <div class="col-md-4 col-sm-4">
                            <div id="price_single_main" class="hotel">
                                per night <span><sup>PKR </sup><?php echo number_format($details->SellingPrice, 0); ?></span><p>Includes all Tax</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <aside class="col-md-4">
                    ...
                    <div class="box_style_1 expose">
                        ...
                        ?>
                        <br>
                        <?php if($hotel[0]->NoOfRooms == 50) { ?>
                        <p style="text-align: center; color:#ff0000; font-size: 18px;"><b>Launching Soon</b></p>
                        <?php } elseif ($hotel[0]->NoOfRooms <= $BookedRoom) { ?>
                        <p style="text-align: center; color:#ff0000; font-size: 18px;"><b>There is no sufficient rooms in this guest house. Please select another guest house. Thanks</b></p>
                        <?php } else { ?>
