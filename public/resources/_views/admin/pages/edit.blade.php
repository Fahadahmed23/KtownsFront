...
<html>
    <head>
        ...
        <title>{{ $configuration->WebsiteTitle }} | Edit Page</title>
    ...
    <body class="hold-transition skin-blue sidebar-mini">
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <!-- Main content -->
                {!! Form::open([ 'url' => 'admin/pages/edit']) !!}
                            ...
                            <div class="box box-primary">
                                <div class="box-header with-border">
                                    ...
                                    <div class="box-tools pull-right">
                                        ...
                                        <button type="button" class="btn btn-sm btn-warning" onclick="location.href = '{{ url('admin/pages') }}'"><i class="fa fa-times"></i> Cancel</button>
                                    </div>
                                </div>
                                <div class="box-body">
                                    <div class="row">
                                            ...
                                            <div class="box box-primary">
                                                ...
                                                <div class="box-body">
                                                    <div class="form-group">
                                                        ...
                                                        {!! Form::text('Title', $pages->Title, ['placeholder' => 'Enter Title', 'class' => 'form-control', 'id' => 'Title ']) !!}
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="Content">Content: <span class="mandatory">*</span></label>
                                                        {!! Form::textarea('Content', $pages->Content, ['placeholder' => 'Enter Content', 'class' => 'form-control', 'id' => 'Content', 'rows' => '3']) !!}
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="MetaTitle">Meta Title:</label>
                                                        {!! Form::text('MetaTitle', $pages->MetaTitle, ['placeholder' => 'Enter Meta Title', 'class' => 'form-control', 'id' => 'MetaTitle']) !!}
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="MetaKeywords">Meta Keywords:</label>
                                                        {!! Form::textarea('MetaKeywords', $pages->MetaKeywords, ['placeholder' => 'Enter Meta Keywords', 'class' => 'form-control', 'id' => 'MetaKeywords', 'rows' => '3']) !!}
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="MetaDescription">Meta Description: </label>
                                                        {!! Form::textarea('MetaDescription', $pages->MetaDescription, ['placeholder' => 'Enter Meta Description', 'class' => 'form-control', 'id' => 'MetaDescription', 'rows' => '3']) !!}
                                                    </div>
                                                    {!! Form::hidden('ItemID', $pages->PageID, ['id' => 'ItemID']) !!}
                                                </div>
                                            </div>
                                            <!-- /.box -->
                                        </div>
                                            ...
                                            <div class="box box-primary">
                                                ...
                                                <div class="box-body">
                                                    <div class="form-group">
                                                        ...
                                                        <label>
                                                            {!! Form::radio('Status', 1, ((int)$pages->Status == 1) ? true : null) !!}
                                                            Active
                                                        </label>
                                                        <label>
                                                            {!! Form::radio('Status', 0, ((int)$pages->Status == 0) ? true : null) !!}
                                                            Deactive
                                                        </label>
                                                    </div>
                                                </div>
