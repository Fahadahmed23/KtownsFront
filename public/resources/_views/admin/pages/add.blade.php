...
<html>
    <head>
        ...
        <title>{{ $configuration->WebsiteTitle }} | Add New Page</title>
                                            ...
                                            <div class="box box-primary">
                                                ...
                                                <div class="box-body">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        {!! Form::textarea('Content', null, ['placeholder' => 'Enter Content', 'class' => 'form-control', 'id' => 'Content', 'rows' => '3']) !!}
                                                    </div>
                                                    <div class="form-group">
