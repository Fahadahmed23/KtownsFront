...
<html>
    <head>
        ...
        <title>{{ $configuration->WebsiteTitle }} | View Experiences Booking</title>
        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <h1>Experiences Bookings</h1>
                    <ol class="breadcrumb">
                        <li><a href="{{ url('admin') }}"><i class="fa fa-dashboard"></i> Home</a></li>
                        <li><a href="{{ url('admin/bookings') }}">Experiences Bookings</a></li>
                        <li class="active">View</li>
                    </ol>
                </section>

                <!-- Main content -->
                {!! Form::open([ 'url' => 'admin/experiences-bookings/'.$booking->ExperiencesBookingID]) !!}
                            ...
                            <div class="box box-primary">
                                <div class="box-header with-border">
                                    ...
                                    <div class="box-tools pull-right">
                                        ...
                                        <button type="button" class="btn btn-sm btn-warning" onclick="location.href = '{{ url('admin/experiences-bookings') }}'"><i class="fa fa-times"></i> Cancel</button>
                                    </div>
                                </div>
                                <div class="box-body">
                                    <div class="row">
                                        <div class="col-md-8">
                                            ...
                                            <div class="box box-primary">
                                                <div class="box-header with-border">
                                                    <h3 class="box-title"> Experiences Booking Info</h3>
                                                </div>
                                                <div class="box-body">
                                                    <table class="table table-bordered">
                                                        <thead>
