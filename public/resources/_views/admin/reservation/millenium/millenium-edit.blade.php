...
<html>
    <head>
        ...
        <title>{{ $configuration->WebsiteTitle }} | Edit Millenium Reservation</title>
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li><a href="javascript:void(0);">Millenium Reservation</a></li>
                        <li class="active">Edit New Reservation</li>
                    </ol>
                </section>
                <!-- Main content -->
                <section class="content">
                    {!! Form::open([ 'url' => 'admin/millenium/reservation/'.$BookingDetail->BookingID, 'files' => true]) !!}
                    <div class="row">
                        <div class="col-md-12">
                            <div class="box box-primary">
                                <div class="box-header with-border">
                                    <h3 class="box-title">Edit Millenium Reservation</h3>
                                            ...
                                            <div class="box box-primary">
                                                ...
                                                <div class="box-body">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <label>
                                                            <?php if($BookingDetail->CheckingStatus != 2) { ?><button type="button" class="btn btn-sm btn-warning" onclick="location.href = '{{ url('admin/millenium/reservation/checkoutpayment/'.$BookingDetail->BookingID) }}'"><?php } ?>{!! FORM::radio('CheckingStatus', 2, ($BookingDetail->CheckingStatus == 2 ? true : null)) !!} 
                                                            Check Out</button>
                                                        </label>
                                                        <?php } else { ?>
                                                            <label>
