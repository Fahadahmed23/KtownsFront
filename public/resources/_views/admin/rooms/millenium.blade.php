                        ...
                        <div class="col-xs-12">
                            <div class="box box-success">
                                <div class="box-header with-border">
                                    <h3 class="box-title">Millenium Room Bookings</h3>
                                    <div class="box-tools pull-right">
                                        <a class="btn btn-primary trial" title="Listing" href="{{url('admin/millenium/dashboard')}}" role="button"><i class="fa fa-list"></i><span class="hidden-md hidden-sm hidden-xs"> Millenium Dashboard</span></a>
                                        <a class="btn btn-primary trial" title="Listing" href="{{url('admin/millenium/reservation')}}" role="button"><i class="fa fa-list"></i><span class="hidden-md hidden-sm hidden-xs"> Millenium Booking List</span></a>
                                        <a class="btn btn-primary trial" title="Make reservation" href="{{url('admin/millenium/reservation/add')}}" role="button"><i class="fa fa-plus"></i><span class="hidden-md hidden-sm hidden-xs"> Make reservation</span></a>
                                    </div>
                                </div>
 ...
 modal.showUrl("room_new.php");
                                    ...
                                    <script>
                                        ...
                                        dp.onEventMoved = function (args) {
                                            $.get("{{ url('admin/millenium/backendmove') }}",
                                                    {
                                                        id: args.e.id(),
                                        ...
                                        dp.onEventClick = function (args) {
                                         ...
                                         window.location.href = "/admin/millenium/reservation/"+args.e.id();
                                        ...
                                        function loadEvents() {
                                            ...
                                            $.get("{{ url('admin/millenium/roombookinglist') }}",
                                                    {
                                        ...
                                        function loadResources() {
                                            ...
                                            $.get("{{ url('admin/millenium/roomlist') }}",
                                                    /*{capacity: 0},*/
                                                            function (data) {
                                                                dp.resources = data;
                                                                dp.update();
