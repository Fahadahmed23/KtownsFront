...
<html>
    <head>
        ...
        <title>{{ $configuration->WebsiteTitle }} | Add New Hotel Type</title>
        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content">
                    {!! Form::open([ 'url' => 'admin/hotel-types/add', 'files' => true]) !!}
                    <div class="row">
                        <div class="col-md-12">
                                            ...
                                            <div class="box box-primary">
                                                ...
                                                <div class="box-body">
                                                    <div class="form-group">
                                                        ...
                                                        {!! Form::text('HotelTypeName', null, ['placeholder' => 'Enter Hotel Type', 'class' => 'form-control', 'id' => 'HotelTypeName']) !!}
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="Color">Color: <span class="mandatory">*</span></label>
                                                        {!! Form::text('Color', null, ['placeholder' => 'Enter Color', 'class' => 'form-control', 'id' => 'Color']) !!}
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="Border">Border Color: <span class="mandatory">*</span></label>
                                                        {!! Form::text('Border', null, ['placeholder' => 'Enter Border Color', 'class' => 'form-control', 'id' => 'Border']) !!}
                                                    </div>
                                                    <div class="form-group">
                                                ...
                                                <div class="box-body">
                                                    <div class="form-group">
                                                        ...
                                                        foreach ($services as $service) {
                                                            echo '<label>' . Form::checkbox("ServiceIDs[]", $service->ServiceID, null, ['class' => 'ServiceID']) . ' ' . $service->ServiceName . '</label><br>';
                                                        }
                                                        ?>
                                                    </div>
                                                    <div class="form-group">
