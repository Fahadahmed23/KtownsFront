...
<html>
    <head>
        ...
        <title>{{ $configuration->WebsiteTitle }} | Hotel Types</title>
        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <h1><i class="fa fa-edit"></i> Hotel Types</h1>
                    <ol class="breadcrumb">
                        <li><a href="{{ url('admin') }}"><i class="fa fa-dashboard"></i> Home</a></li>
                        <li class="active">Hotel Types</li>
                    </ol>
                </section>
                <!-- Main content -->
                {!! Form::open([ 'url' => 'admin/hotel-types/delete', 'id' => 'frm_list' ]) !!}
                <section class="content">
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="box box-success">
                                <div class="box-header with-border">
                                    <h3 class="box-title">Hotel Types</h3>
                                    <div class="box-tools pull-right">
                                        <button type="button" class="btn btn-sm btn-primary" onClick="location.href = '{{ url('admin/hotel-types/add') }}'"><i class="fa fa-plus"></i> Add New</button>
        ...
        <script language="javascript">
                                            ...
                                            function doDelete()
                                            {
                                                if (checkboxes.filter(':checked').length > 0)
                                                {
                                                    ...
                                                    message_box("Confirm", "This will delete all selected Hotel Types.<br>Are you sure?", "confirm", ok, null);
                                                } else
                                                {
                                                    message_box("Alert", "Please select Hotel Type to delete", "alert", null, null);
                                                }
                                            }
        </script>
    </body>
