...
<html>
    <head>
        ...
        <title>{{ $configuration->WebsiteTitle }} | Clients</title>
        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <h1><i class="fa fa-edit"></i> Clients</h1>
                    <ol class="breadcrumb">
                ...
                <!-- Main content -->
                {!! Form::open([ 'url' => 'admin/clients/delete', 'id' => 'frm_list' ]) !!}
                            ...
                            <div class="box box-success">
                                <div class="box-header with-border">
                                    ...
                                    <div class="box-tools pull-right">
                                        <button type="button" class="btn btn-sm btn-primary" onClick="location.href = '{{ url('admin/clients/add') }}'"><i class="fa fa-plus"></i> Add New</button>
        ...
        <script language="javascript">
                                            ...
                                            function doDelete()
                                            {
                                                if (checkboxes.filter(':checked').length > 0)
                                                {
                                                    ...
                                                    message_box("Confirm", "This will delete all selected Clients.<br>Are you sure?", "confirm", ok, null);
                                                } else
                                                {
                                                    message_box("Alert", "Please select Client to delete", "alert", null, null);
                                                }
                                            }
        </script>
    </body>
