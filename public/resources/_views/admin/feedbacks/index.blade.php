...
<html>
    <head>
        ...
        <title>{{ $configuration->WebsiteTitle }} | Feedbacks</title>
    ...
    <body class="hold-transition skin-blue sidebar-mini">
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <h1><i class="fa fa-edit"></i> Feedbacks</h1>
                    <ol class="breadcrumb">
                ...
                <!-- Main content -->
                {!! Form::open([ 'url' => 'admin/feedbacks/delete', 'id' => 'frm_list' ]) !!}
                            ...
                            <div class="box box-success">
                                <div class="box-header with-border">
                                    ...
                                    <div class="box-tools pull-right">
                                        ...
                                        {!! Form::select('HotelID', $hotels, null, ['class' => 'filterHotels form-control pull-right', 'id' => 'HotelID', 'style' => 'width:200px; margin-right: 20px;']) !!}
                                        {!! Form::select('UserID', $users, null, ['class' => 'filterUsers form-control pull-right', 'id' => 'UserID', 'style' => 'width:200px; margin-right: 20px;']) !!}
                                    </div>
                                </div>
                                <div class="box-body">
        ...
        <script language="javascript">
                                            ...
                                            $(function () {
                                                ...
                                                $(".filterHotels").change(function () {
                                                    data_list.fnReloadAjax("{{ url(Request::path()) }}?hotel_id=" + $(this).val());
                                                    data_list.fnClearTable(0);
                                                    data_list.fnDraw();
                                                });

                                                $(".filterUsers").change(function () {
                                                    data_list.fnReloadAjax("{{ url(Request::path()) }}?user_id=" + $(this).val());
                                                    data_list.fnClearTable(0);
                                                    data_list.fnDraw();
                                                });
                                            ...
                                            function doDelete()
                                            {
                                                if (checkboxes.filter(':checked').length > 0)
                                                {
                                                    ...
                                                    message_box("Confirm", "This will delete all selected Feedbacks.<br>Are you sure?", "confirm", ok, null);
                                                } else
                                                {
                                                    message_box("Alert", "Please select Feedbacks to delete", "alert", null, null);
                                                }
                                            }
        </script>
    </body>
