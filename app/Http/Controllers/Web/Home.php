...
class Home extends WebController {
    ...
    public function index() {
        ...
        $this->data['sliders'] = DB::table('sliders')->where('Status', 1)->get();
        $this->data['testimonials'] = Db::table('testimonials')->where('Status', 1)->get();
        // dd($this->data['testimonials']);
        $this->data['hotels'] = [];
