...
<html>
    <head>
        ...
        <title>{{ $configuration->WebsiteTitle }} | Edit Testimonial</title>
    ...
    <body class="hold-transition skin-blue sidebar-mini">
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <!-- Main content -->
                {!! Form::open([ 'url' => 'admin/testimonials/edit']) !!}
                            ...
                            <div class="box box-primary">
                                <div class="box-header with-border">
                                    ...
                                    <div class="box-tools pull-right">
                                        ...
                                        <button type="button" class="btn btn-sm btn-warning" onclick="location.href = '{{ url('admin/testimonials') }}'"><i class="fa fa-times"></i> Cancel</button>
                                    </div>
                                </div>
                                <div class="box-body">
                                    <div class="row">
                                            ...
                                            <div class="box box-primary">
                                                ...
                                                <div class="box-body">
                                                    <div class="form-group">
                                                        ...
                                                        {!! Form::text('Name', $testimonials->Name, ['placeholder' => 'Enter Name', 'class' => 'form-control', 'id' => 'Name']) !!}
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="Testimonial">Testimonial: <span class="mandatory">*</span></label>
                                                        {!! Form::textarea('Testimonial', $testimonials->Testimonial, ['placeholder' => 'Enter Testimonial', 'class' => 'form-control', 'id' => 'Testimonial', 'rows' => '3']) !!}
                                                    </div>
                                                    {!! Form::hidden('ItemID', $testimonials->TestimonialID, ['id' => 'ItemID']) !!}
                                                </div>
                                            </div>
                                            <!-- /.box -->
                                        </div>
                                            ...
                                            <div class="box box-primary">
                                                ...
                                                <div class="box-body">
                                                    <div class="form-group">
                                                        ...
                                                        <label>
                                                            {!! Form::radio('Status', 1, ((int)$testimonials->Status == 1) ? true : null) !!}
                                                            Active
                                                        </label>
                                                        <label>
                                                            {!! Form::radio('Status', 0, ((int)$testimonials->Status == 0) ? true : null) !!}
                                                            Deactive
                                                        </label>
                                                    </div>
                                                </div>
