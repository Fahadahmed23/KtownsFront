...
<html>
    <head>
        ...
        <title>{{ $configuration->WebsiteTitle }} | Add New Testimonial</title>
        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content">
                    {!! Form::open([ 'url' => 'admin/testimonials/add']) !!}
                    <div class="row">
                        <div class="col-md-12">
                                            ...
                                            <div class="box box-primary">
                                                ...
                                                <div class="box-body">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        {!! Form::textarea('Testimonial', null, ['placeholder' => 'Enter Testimonial', 'class' => 'form-control', 'id' => 'Testimonial', 'rows' => '3']) !!}
                                                    </div>
                                                </div>
                                            </div>
                                            <!-- /.box -->
