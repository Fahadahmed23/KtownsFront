...
<html>
    <head>
        ...
        <title>{{ $configuration->WebsiteTitle }} | Hotel Images</title>
        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <h1><i class="fa fa-edit"></i> Hotel Images</h1>
                    <ol class="breadcrumb">
                        <li><a href="{{ url('admin') }}"><i class="fa fa-dashboard"></i> Home</a></li>
                        <li class="active">Hotel Images</li>
                    </ol>
                </section>
                <!-- Main content -->
                {!! Form::open([ 'url' => 'admin/hotel-images/delete/'.$HotelID, 'id' => 'frm_list' ]) !!}
                            ...
                            <div class="box box-success">
                                <div class="box-header with-border">
                                    ...
                                    <div class="box-tools pull-right">
                                        <button type="button" class="btn btn-sm btn-primary" onClick="location.href = '{{ url('admin/hotel-images/add/'.$HotelID) }}'"><i class="fa fa-plus"></i> Add New</button>
                                        ...
                                        <button type="button" class="btn btn-sm btn-warning btnTools" onClick="location.href = '{{ url('admin/hotels/'.$HotelID) }}'" id="btnDelete"><i class="fa fa-times"></i> Back</button>
                                    </div>
                                </div>
