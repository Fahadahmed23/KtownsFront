...
<html>
    <head>
        ...
        <title>{{ $configuration->WebsiteTitle }} | Edit City</title>
    ...
    <body class="hold-transition skin-blue sidebar-mini">
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <!-- Main content -->
                {!! Form::open([ 'url' => 'admin/cities/'.$city->CityID, 'files' => true]) !!}
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="box box-primary">
                                                ...
                                                <div class="box-body">
                                                    <div class="form-group">
                                                        ...
                                                        {!! Form::text('CityName', $city->CityName, ['placeholder' => 'Enter City Name', 'class' => 'form-control', 'id' => 'CityName']) !!}
                                                    </div>
                                                </div>
                                            </div>
                                            <!-- /.box -->
                                        ...
                                        <div class="col-md-4">
                                            <div class="box box-primary">
                                                ...
                                                <div class="box-body">
                                                    <div class="form-group">
                                                        <label for="Image">Image: <span class="mandatory">*</span> (best width = 60px, height = 60px)</label>
                                                        {!! Form::file('Image') !!}
                                                    </div>

                                                    <img src="<?php echo $upload_url . 'cities/' . $city->Image ?>" style="width:150px; height: auto;" />

                                                    <div class="form-group">
                                                        <label for="Status">Status</label><br>
                                                        <label>
                                                            {!! FORM::radio('Status', 1, ($city->Status == 1 ? true : null)) !!}
                                                            Active
                                                        </label>
                                                        <label>
                                                            {!! FORM::radio('Status', 0, ($city->Status == 0 ? true : null)) !!}
                                                            Deactive
                                                        </label>
                                                    </div>
                                                </div>
