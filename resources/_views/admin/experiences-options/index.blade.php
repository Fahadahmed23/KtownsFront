...
<html>
    <head>
        ...
        <title>{{ $configuration->WebsiteTitle }} | Experiences Options</title>
        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <h1><i class="fa fa-edit"></i> Experiences Options</h1>
                    <ol class="breadcrumb">
                        <li><a href="{{ url('admin') }}"><i class="fa fa-dashboard"></i> Home</a></li>
                        <li class="active">Experiences Options</li>
                    </ol>
                </section>
                <!-- Main content -->
                {!! Form::open([ 'url' => 'admin/experiences-options/delete/'.$ExperiencesID, 'id' => 'frm_list' ]) !!}
                <section class="content">
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="box box-success">
                                <div class="box-header with-border">
                                    <h3 class="box-title">Experiences Options</h3>
                                    <div class="box-tools pull-right">
                                        <button type="button" class="btn btn-sm btn-primary" onClick="location.href = '{{ url('admin/experiences-options/add/'.$ExperiencesID) }}'"><i class="fa fa-plus"></i> Add New</button>
                                        ...
                                        <button type="button" class="btn btn-sm btn-warning btnTools" onClick="location.href = '{{ url('admin/experiences/'.$ExperiencesID) }}'" id="btnDelete"><i class="fa fa-times"></i> Back</button>
                                    </div>
                                </div>
        ...
        <script language="javascript">
                                            ...
                                            function doDelete()
                                            {
                                                if (checkboxes.filter(':checked').length > 0)
                                                {
                                                    ...
                                                    message_box("Confirm", "This will delete all selected Images.<br>Are you sure?", "confirm", ok, null);
                                                } else
                                                {
                                                    message_box("Alert", "Please select Image to delete", "alert", null, null);
                                                }
                                            }
        </script>
    </body>
