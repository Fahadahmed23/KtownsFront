...
<html>
    <head>
        ...
        <title>{{ $configuration->WebsiteTitle }} | Add New Experiences Image</title>
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li><a href="{{ url('admin/experiences-images/'.$ExperiencesID) }}">Experiences Options</a></li>
                ...
                <section class="content">
                    {!! Form::open([ 'url' => 'admin/experiences-options/add/'.$ExperiencesID, 'files' => true]) !!}
                    <div class="row">
                        <div class="col-md-12">
                                        ...
                                        <div class="col-md-4">
                                            <div class="box box-primary">
                                                ...
                                                <div class="form-group">
                                                        ...
                                                        <label>
                                                            {!! Form::radio('Options', '1') !!} Place 
                                                        </label>
                                                        <br>
                                                        <label>
                                                            {!! Form::radio('Options', '2') !!} Distance
                                                        </label>
                                                        <br>
                                                        <label>
                                                            {!! Form::radio('Options', '3') !!} Food
                                                        </label>
                                                        <br>
                                                        <label>
                                                            {!! Form::radio('Options', '4') !!} Language
                                                        </label>
                                                </div>
                                            </div>
                                        </div>
