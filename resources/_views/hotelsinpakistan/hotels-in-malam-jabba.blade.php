...
<html>
    <head>
        ...
        <title>Hotels in Malam Jabba | Guest House In Malam Jabba | Ktown Rooms</title>
        <meta name="description" content="Book a hotels in Malam Jabba, get the best hotels and guest house deals in Malam Jabba with the facilities of Free WiFi, free breakfast, AC, 32″ LED in a room.">
        <!-- Favicons-->
    ...
    <body>
        ...
        <section class="parallax-window" data-parallax="scroll" data-image-src="{{ url('resources/assets/web') }}/img/covers/mallam-jabba-cover.jpg" data-natural-width="1400" data-natural-height="470">
            <div class="parallax-content-1">
                <div class="animated fadeInDown">
                    <h1>Malam Jabba Top Hotels</h1>
        ...
        <div  class="container margin_60">
            ...
            <div class="row">
                ...
                <div class="col-lg-9 col-md-9">
                    <div>
                        <h1 style="margin-top:0px;">HOTELS IN MALAM JABBA</h1>
                        <p>Malam Jabba is a Hill Station found 8700 feet above ocean level, on the Karokaram mountain. It was initially a skiing resort made by Pakistan Tourism and Development Corporation, however it was destroyed couple of years ago. Malam Jabba is a skiing spot, and there are numerous hotels in Larkana where one can relax on his/her trips as tourists would definitely need a place to stay if they are visiting Malam Jabba away from his/her home.<span id="dots">...</span></p>
                           <div id="more">
                               <ul style="list-style: none;">
                                   <li>
                                       <strong>1. Skiing</strong><br>
                                        <p>Malam Jabba has a ski slope of around 800 m with the highest peak of slope. The hotel was constructed with the help of Austria, yet it was destroyed couple of years ago; however it was again constructed in 2014 by Samson Group of Companies to increase tourism.</p>
                                        
                                   </li>
                                   <li>
                                    <strong>2. Ice skating and Trekking</strong><br>
                                    <p>Tourists enjoy roller and ice skating on the ski hills of Malam Jabba. In case, some travelers do not like skiing they can entertain themselves with different activities. There are two trekking trails situated in Malam Jabba . The first one goes through the Ghorband Valley and Shangla Top and begins around 18 km from where the hotel in Malam Jabba was located. The other trail goes through the Sabonev Valley and is around 17 km from where the hotel was.</p>
                    ...
                    ?>
                    <hr>
                    <!--<img src="{{ url('public/uploads/website/hotels/hotels-in-malam-jabba/malam-jabba-swat.png') }}">
                    <hr>
                    <img src="{{ url('public/uploads/website/hotels/hotels-in-malam-jabba/malam-jabba.png') }}">
                    <hr>
                    <img src="{{ url('public/uploads/website/hotels/hotels-in-malam-jabba/malam-jabba-kpk.png') }}">-->
                </div>
            </div>
        </div>
