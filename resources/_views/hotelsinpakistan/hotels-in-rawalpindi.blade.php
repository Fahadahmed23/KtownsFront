...
<html>
    <head>
        ...
        <title>Hotels in Rawalpindi | Guest House In Rawalpindi | Ktown Rooms</title>
        <meta name="description" content="Book a hotels in Rawalpindi, get the best hotels and guest house deals in Rawalpindi with the facilities of Free WiFi, free breakfast, AC, 32″ LED in a room.">
        <!-- Favicons-->
    ...
    <body>
        ...
        <section class="parallax-window" data-parallax="scroll" data-image-src="{{ url('resources/assets/web') }}/img/covers/rawalpindi-cover.jpg" data-natural-width="1400" data-natural-height="470">
            <div class="parallax-content-1">
                <div class="animated fadeInDown">
                    <h1>Rawalpindi Top Hotels</h1>
        ...
        <div  class="container margin_60">
            ...
            <div class="row">
                ...
                <div class="col-lg-9 col-md-9">
                    <div>
                        <h1 style="margin-top:0px;">HOTELS IN RAWALPINDI</h1>
                    ...
                    ?>
                    <hr>
                    <!--<img src="{{ url('public/uploads/website/hotels/hotels-in-rawalpindi/bahria-express-way.png') }}">
                    <hr>
                    <img src="{{ url('public/uploads/website/hotels/hotels-in-rawalpindi/234-hub.png') }}">
                    <hr>
                    <img src="{{ url('public/uploads/website/hotels/hotels-in-rawalpindi/lane-3-a.png') }}">-->
                </div>
            </div>
        </div>
