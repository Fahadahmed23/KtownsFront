...
<html>
    <head>
        ...
        <title>Hotels in Muzaffarabad | Guest House In Muzaffarabad | Ktown Rooms</title>
        <meta name="description" content="Book a hotels in Muzaffarabad, get the best hotels and guest house deals in Muzaffarabad with the facilities of Free WiFi, free breakfast, AC, 32″ LED in a room.">
        <!-- Favicons-->
    ...
    <body>
        ...
        <section class="parallax-window" data-parallax="scroll" data-image-src="{{ url('resources/assets/web') }}/img/covers/muzafarabad-cover.jpg" data-natural-width="1400" data-natural-height="470">
            <div class="parallax-content-1">
                <div class="animated fadeInDown">
                    <h1>Muzaffarabad Top Hotels</h1>
        ...
        <div  class="container margin_60">
            ...
            <div class="row">
                ...
                <div class="col-lg-9 col-md-9">
                    <div>
                        <h1 style="margin-top:0px;">HOTELS IN MUZAFFARABAD</h1>
                        <p>Muzaffarabad is the capital of Azad Kashmir in Pakistan. It lies on the banks of the Jhelum and Neelum rivers. In1999, the population increased to around 750,000. Muzaffarabad was named after its founder, Sultan Muhammad Muzaffar Khan, who was from Bamba Tribe. Residents in Muzaffarabad usually speak Punjabi and Kashmiri. To make the stay of all travelers memorable and comfortable, they have constructed best hotels and best guest houses in Muzaffarabad at low rates.<span id="dots">...</span></p>
                           <div id="more">
                               <ul style="list-style: none;">
                                   <li>
                                       <strong>1. The Red Fort </strong><br>
                                        <p>Sultan Muzaffar Khan, the originator of Muzaffarabad city, completed the development of the Red Fort in 1646. The Dogra rulers further recreated and expanded the political and military tasks. The architecture of the fort shows a smooth design and structure. It is covered on three sides by the Neelum River also known as the Kishan Ganga River with steps leading to the banks of the river.</p>
                                   </li>
                                   <li>
                                    <strong>2. Pir Chinasi </strong><br>
                                    <p>Pir Chinasi is found in the east of Muzaffarabad. It offers travelers with a beautiful view of Muzaffarabad and is a top rated choice! The lush green peak is perfect for climbing, trekking and outdoors activities. The travel industry has developed cheap hotels, best guest house at Saran, found 30 kilometers east of Muzaffarabad city on the highest point of a hill.</p>
                                   </li>
                                   <li>
                                       <strong>3. Chikaar</strong><br>
                                        <p>Chikaar is an amazing summer station or a vacation spot found 46 kilometers from Muzaffarabad. A number of best hotels in Muzzafrabad as well as guest houses in Muzzafrabad are accessible here for travelers to make their stay comfortable and to make their trip memorable.</p>
                                        <p>If you are traveling far away from your city to enjoy your vacations you would definitely need a place to stay in Muzzafrabad. For this purpose, Ktown Rooms has developed their cheap hotels and guest houses in Muzzafrabad to serve the needs of the travelers coming for vacations. Along with comfortable accommodation Ktown Rooms offers air conditioners, 32” LED, Wifi, breakfast and a lot more.</p>
                                   </li>
                               </ul>
                           </div>
                    ...
                    ?>
                    <hr>
                    <!--<img src="{{ url('public/uploads/website/hotels/hotels-in-muzaffarabad/upper-chattar.png') }}">
                    <hr>
                    <img src="{{ url('public/uploads/website/hotels/hotels-in-muzaffarabad/near-read-fort.png') }}">
                    <hr>
                    <img src="{{ url('public/uploads/website/hotels/hotels-in-muzaffarabad/bank-square.png') }}">-->
                </div>
            </div>
        </div>
