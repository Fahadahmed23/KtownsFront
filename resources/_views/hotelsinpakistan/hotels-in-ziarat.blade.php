...
<html>
    <head>
        ...
        <title>Hotels in Ziarat | Guest House In Ziarat | Ktown Rooms</title>
        <meta name="description" content="Book a hotels in Ziarat, get the best hotels and guest house deals in Ziarat with the facilities of Free WiFi, free breakfast, AC, 32″ LED in a room.">
        <!-- Favicons-->
    ...
    <body>
        ...
        <section class="parallax-window" data-parallax="scroll" data-image-src="{{ url('resources/assets/web') }}/img/covers/ziarat-cover.jpg" data-natural-width="1400" data-natural-height="470">
            <div class="parallax-content-1">
                <div class="animated fadeInDown">
                    <h1>Ziarat Top Hotels</h1>
        ...
        <div  class="container margin_60">
            ...
            <div class="row">
                ...
                <div class="col-lg-9 col-md-9">
                        ...
                        <p>The best time to visit Ziarat is from May to September. Other than these months the temperature in Ziarat is cold and dry, and not a best option to be considered for vacations or tour if you do not have equipment’s for the cold weather. Ktown Rooms has eliminated these issues, it provides you with all the equipment’s in the hotels of Ziarat needed for winters. Ktown Rooms offers heaters, breakfast, wifi and more at low rates to increase tourism in winters.<span id="dots">...</span></p>
                           <div id="more">
                               <ul style="list-style: none;">
                                   <li>
                                       <strong>1. Quaid-e-Azam Residency</strong><br>
                                        <p>It is the most popular milestone in the city, a residency where Quaid-e-Azam spent his last few months before he passed away. The structure was initially built in 1892, and is entirely made out of wood. The structure was renovated in 2014 after the attack.</p>
                                   </li>
                                   <li>
                                    <strong>2. Prospect Point</strong><br>
                    ...
                    ?>
                    <hr>
                    <!--<img src="{{ url('public/uploads/website/hotels/hotels-in-ziarat/residencyroad.png') }}">
                    <hr>
                    <img src="{{ url('public/uploads/website/hotels/hotels-in-ziarat/loralairoad.png') }}">
                    <hr>
                    <img src="{{ url('public/uploads/website/hotels/hotels-in-ziarat/puranabus.png') }}">-->
                </div>
            </div>
        </div>
