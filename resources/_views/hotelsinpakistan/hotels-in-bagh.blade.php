...
<html>
    <head>
        ...
        <title>Hotels in Bagh | Guest House In Bagh | Ktown Rooms</title>
        <meta name="description" content="Book a hotels in Bagh, get the best hotels and guest house deals in Bagh with the facilities of Free WiFi, free breakfast, AC, 32″ LED in a room.">
        <!-- Favicons-->
    ...
    <body>
        ...
        <section class="parallax-window" data-parallax="scroll" data-image-src="{{ url('resources/assets/web') }}/img/covers/bagh-cover.jpg" data-natural-width="1400" data-natural-height="470">
            <div class="parallax-content-1">
                <div class="animated fadeInDown">
                    <h1>Bagh Top Hotels</h1>
        ...
        <div  class="container margin_60">
            ...
            <div class="row">
                ...
                <div class="col-lg-9 col-md-9">
                    <div>
                        <h1 style="margin-top:0px;">HOTELS IN BAGH</h1>
                       <p>The Bagh is a greenest zone due to which it is named as Bagh (Garden). This was set up by the landowner, where the premises of the Forest Department are found now. Resultantly, this area is headquarters now. The area is a mountainous area, it falls in the Himalayas Zone. These ranges are called Pir-Panjal which is at height of 3421 meters above ocean level. Mountains are commonly covered with trees. Two main streams of Bagh are Mahl Nala and Betar Nala.<span id="dots">...</span></p>
                           <div id="more">
                               <ul style="list-style: none;">
                                   <li>
                                       <strong>1. Sudhan Gali</strong><br>
                                        <p>Sudhan Gali situated at a height of 2134m above ocean level and few kms away from Bagh. This beautiful spot is famous for camping and it is also famous among those who like climbing/trekking on the Ganga Choti (3045m high mountain).</p>
                                        <p>It takes few hours to reach Sudhan Gali from Muzzaffrabad on a jeep. There are two guest houses in Sudhan Gali for accommodations of the tourists that are maintained by by AJK Tourism office and Public Works Department (PWD) individually. Booking of a room is done through their office in Muzaffarabad, strong reference is needed to book a room. Ktown Rooms has planned to construct cheap hotels and gust houses in Sudhan Gali to eliminate this issue, the hotel would accommodate numerous guests and no strong reference would be needed. Booking would be done through website or application; tourists would not have to come to the office to book a room.</p>
                                   </li>
                                   <li>
                                    <strong>2. Dheerkot</strong><br>
                                    <p>Dheerkot is wonderful and enchanting spot found 24Km from Kohala. Dhirkot has an incredibly amazing weather. The place is amust visit attraction in Bagh among tourists as it is easily accessible,reasonable elevation and beautiful scenery with Deodar and kail woods.</p>
                                    <p>In Deodar, there is an elegant Forest guest house, Tourist Huts and a Log Hut, which are enormously booked by travelers in summer.</p>
                                   </li>
                                   <li>
                                       <strong>3. Neela Butt</strong><br>
                    ...
                    ?>
                    <hr>
                    <!--<img src="{{ url('public/uploads/website/hotels/hotels-in-bagh/bagh-bypass.png') }}">
                    <hr>
                    <img src="{{ url('public/uploads/website/hotels/hotels-in-bagh/dhulli-road.png') }}">
                    <hr>
                    <img src="{{ url('public/uploads/website/hotels/hotels-in-bagh/main-sudhan.png') }}">-->
                </div>
            </div>
        </div>
