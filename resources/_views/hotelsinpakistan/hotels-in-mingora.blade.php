...
<html>
    <head>
        ...
        <title>Hotels in Mingora | Guest House In Mingora | Ktown Rooms</title>
        <meta name="description" content="Book a hotels in Mingora, get the best hotels and guest house deals in Mingora with the facilities of Free WiFi, free breakfast, AC, 32″ LED in a room.">
        <!-- Favicons-->
    ...
    <body>
        ...
        <section class="parallax-window" data-parallax="scroll" data-image-src="{{ url('resources/assets/web') }}/img/covers/mingora-cover.jpg" data-natural-width="1400" data-natural-height="470">
            <div class="parallax-content-1">
                <div class="animated fadeInDown">
                    <h1>Mingora Top Hotels</h1>
        ...
        <div  class="container margin_60">
            ...
            <div class="row">
                ...
                <div class="col-lg-9 col-md-9">
                    ...
                    ?>
                    <hr>
                    <!--<img src="{{ url('public/uploads/website/hotels/hotels-in-mingora/fizagat-bypass.png') }}">
                    <hr>
                    <img src="{{ url('public/uploads/website/hotels/hotels-in-mingora/haji-baba.png') }}">
                    <hr>
                    <img src="{{ url('public/uploads/website/hotels/hotels-in-mingora/kalam-road.png') }}">-->
                </div>
            </div>
        </div>
