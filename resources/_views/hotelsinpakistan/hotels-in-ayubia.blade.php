...
<html>
    <head>
        ...
        <title>Hotels in Ayubia | Guest House In Ayubia | Ktown Rooms</title>
        <meta name="description" content="Book a hotels in Ayubia, get the best hotels and guest house deals in Ayubia with the facilities of Free WiFi, free breakfast, AC, 32″ LED in a room.">
        <!-- Favicons-->
...
gtag('config', 'UA-136415631-1');
    ...
    <body>
        ...
        <section class="parallax-window" data-parallax="scroll" data-image-src="{{ url('resources/assets/web') }}/img/covers/ayubia-cover.jpg" data-natural-width="1400" data-natural-height="470">
            <div class="parallax-content-1">
                <div class="animated fadeInDown">
                    <h1>Ayubia Top Hotels</h1>
                ...
                <div class="col-lg-9 col-md-9">
                    <div>
                        ...
                        <div id="more">
                            ...
                            <p>If you are visiting a place that is far away from your home, you would definitely need a place to stay. Ktown Rooms offers best budget hotels in Ayubia to accommodate tourists and provide them best hospitality services so that they have a comfortable stay at affordable prices.</p>
                        </div>
                    ...
                    ?>
                    <hr>
                    <!--<img src="{{ url('public/uploads/website/hotels/hotels-in-ayubia/adjacent-ayubia.png') }}">
                    <hr>
                    <img src="{{ url('public/uploads/website/hotels/hotels-in-ayubia/ayubia-road.png') }}">
                    <hr>
                    <img src="{{ url('public/uploads/website/hotels/hotels-in-ayubia/near-chairlift.png') }}">-->
                </div>
            </div>
        </div>
