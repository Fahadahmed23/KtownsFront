...
<html>
    <head>
        ...
        <title>Hotels in Swat| Guest House In Swat | Ktown Rooms</title>
        <meta name="description" content="Book a hotels in Swat, get the best hotels and guest house deals in Swat with the facilities of Free WiFi, free breakfast, AC, 32″ LED in a room.">
        <!-- Favicons-->
    ...
    <body>
        ...
        <section class="parallax-window" data-parallax="scroll" data-image-src="{{ url('resources/assets/web') }}/img/covers/sawat-cover.jpg" data-natural-width="1400" data-natural-height="470">
            <div class="parallax-content-1">
                <div class="animated fadeInDown">
                    <h1>Swat Top Hotels</h1>
        ...
        <div  class="container margin_60">
            ...
            <div class="row">
                ...
                <div class="col-lg-9 col-md-9">
                    <div>
                        <h1 style="margin-top:0px;">HOTELS IN SWAT</h1>
                        <p>Situated in KPK, the city of Swat is famous for traveler center point. From Alexander the Great, to Buddhists and now Muslims – Swat is considered as home to all. In this way, in Swat there are a great number of buildings,  and other components which have a place with diverse culture and time zones. Foot prints of Buddha are found in the museum of Swat.</p>
                        <p>The valley of Swat is encircled by high mountains, in its north there are Chitral and Ghizer and in its south there are burner district and Malakand zone. Kohistan and Shangla are in the East, and upper Dir areas in the West – it is surrounded by beauty. The area around the Swat valley comprises for the most part of Pashtuns, Gujjar and Kohistani clans with the Pashto language being the most utilized around the area. Towns around the Swat valley incorporate Mingora and Saidu-Sharif (the capital of the Swat area).<span id="dots">...</span></p>
                           <div id="more">
                               <ul style="list-style: none;">
                                   <li>
                                       <strong>Swat Museum</strong><br>
                                        <p>The Swat Museum is between the towns of Mingora and Saidu. Japan had furnished the museum with help, to enhance and increase the collection. There are accumulations of Gandhara models taken by Buddhist destinations in Swat, illustrating Buddha's biography. Also there are utensils, valuable stones, weapons and so forth from the Gandhara accumulation.</p>
                                   </li>
                                   <li>
                                    <strong>Saidu Sharif</strong><br>
                                    <p>Found near the valley, and just 2 km from Mingora, is the well known town of Saidu Sharif. This is a perfect spot for picnics as there is simply greenery all around.  There are spots to remain here, where one can truly appreciate the beautiful magnificence of Swat.</p>
                                   </li>
                                   <li>
                                       <strong>Mahodand Lake</strong><br>
                                        <p>Mahodand lake is also called the "lake of fish," it is situated in the Usho Valley of Swat. It isn't accessible by vehicle, yet you can get there by a four wheeler, and partake in exercises which the lake is popular for, for instance, boating and sailing.</p>
                    ...
                    ?>
                    <hr>
                    <!--<img src="{{ url('public/uploads/website/hotels/hotels-in-swat/fizagat.png') }}">
                    <hr>
                    <img src="{{ url('public/uploads/website/hotels/hotels-in-swat/saidusharif.png') }}">
                    <hr>
                    <img src="{{ url('public/uploads/website/hotels/hotels-in-swat/swatvalleykpk.png') }}">-->
                </div>
            </div>
        </div>
