...
<html>
    <head>
        ...
        <title>Hotels in Shorgan | Guest House In Shorgan | Ktown Rooms</title>
        <meta name="description" content="Book a hotels in Shogran, get the best hotels and guest house deals in Shogran with the facilities of Free WiFi, free breakfast, AC, 32″ LED in a room.">
        <!-- Favicons-->
    ...
    <body>
        ...
        <section class="parallax-window" data-parallax="scroll" data-image-src="{{ url('resources/assets/web') }}/img/covers/shorgan-cover.jpg" data-natural-width="1400" data-natural-height="470">
            <div class="parallax-content-1">
                <div class="animated fadeInDown">
                    <h1>Shorgan Top Hotels</h1>
        ...
        <div  class="container margin_60">
            ...
            <div class="row">
                ...
                <div class="col-lg-9 col-md-9">
                    <div>
                        <h1 style="margin-top:0px;">HOTELS IN SHORGAN</h1>
                        <p>In the north of Pakistan, Shogran is one of the famous hill stations with lush greenery at 2,362 meters (7,749 ft) above ocean level. It is 34 kilometers away from Balakot which is also a must visit place. This hill station is opened for guests in summers and winters; however, in winters the number of hotels in Shogran opened is quite low because snow covers the valley fully. This issue is eliminated by Ktown Rooms as it offers hotels in Shogran even in winters with complete services as well as central heater. Due to this issue June – August are the peak season, and the weather is quite pleasant during this period in addition to this, the rainy season of Hunza is something everyone should experience. <span id="dots">...</span></p>
                           <div id="more">
                               <ul style="list-style: none;">
                                   <li>
                                       <strong>1. Makra</strong><br>
                                        <p>The Makra is a beautiful peak in northern Himalayas of Pakistan. It is just 200 kms from Islamabad. There is a resort with severalhotels in Shogran, the track begins from Siri Lake and finishes at Paye, from this point, the trek of four hours starts to get to the highest point of the Makra. Climbing on the Makra is quite adventurous because of snow and the slope of the mountainsides.</p>
                                        <p>Along with this adventurous experience, Makra offers the stunning views of Hazara and Azad Kashmir. This must visit attractionknown as Makra Peak by residents as the snow on the hills looks like a spider which is called Makra in Urdu.</p>
                                   </li>
                                   <li>
                                    <strong>2. Payee Lake</strong><br>
                                    <p>Payee Lake is the beautiful lake in Shogran which is surrounded by must visit attractions of Shogran like Makra, Malika Parbat and Musa ka Musala. Tourists are found taking pictures, enjoying hot cup of tea, relaxing near this lake.</p>
                                    
                                   </li>
                                   <li>
                                       <strong>3. Siri Lake</strong><br>
                                        <p>Siri Lake is also found close to Shogran in Siri, while in transit to Payee in Kaghan Valley. It is situated at the height of 8,500 ft. Tourist love this lake because of its peacefulness and breath taking view
                    ...
                    ?>
                    <hr>
                    <!--<img src="{{ url('public/uploads/website/hotels/hotels-in-shogran/kaghan-valley.png') }}">
                    <hr>
                    <img src="{{ url('public/uploads/website/hotels/hotels-in-shogran/shogran-road.png') }}">
                    <hr>
                    <img src="{{ url('public/uploads/website/hotels/hotels-in-shogran/shogran-road.png') }}">-->
                </div>
            </div>
