...
<html>
    <head>
        ...
        <title>Hotels in Kalash Valley | Guest House In Kalash Valley | Ktown Rooms</title>
        <meta name="description" content="Book a hotels in Kalash Valley, get the best hotels and guest house deals in Kalash Valley with the facilities of Free WiFi, free breakfast, AC, 32″ LED in a room.">
        <!-- Favicons-->
        ...
        <section class="parallax-window" data-parallax="scroll" data-image-src="{{ url('resources/assets/web') }}/img/covers/karachi-cover.jpg" data-natural-width="1400" data-natural-height="470">
            <div class="parallax-content-1">
                <div class="animated fadeInDown">
                    <h1>Kalash Valley Top Hotels</h1>
