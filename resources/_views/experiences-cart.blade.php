...
<html>
    <head>
        ...
        <title>KTown | Online  Booking Experiences | Guest Houses | Discounted Rates</title>
    ...
    <body>
        ...
        <div id="position">
            <div class="container">
                <ul>
                    ...
                    <li><a href="{{ url('listing') }}">Manage Experiences Booking</a></li>
                    <li>Cart</li>
                </ul>
            </div>
        </div><!-- End position -->
        ...
        <div class="container margin_60">
            <?php
            if (\Session::has('ExperiencesCart') && count(\Session::get('ExperiencesCart')) > 0) {
                $Adults = 0;
                $Children = 0;
                $TotalGuests = 0;
                $TotalRooms = 0;
                                    ...
                                    <tr>
                                        <td>
                                            <div class="thumb_cart">
                                                <img src="{{ url('public/uploads/website/experiences/thumb/'.$session['Thumbnail']) }}" alt="<?php echo $session['ExperiencesName']; ?>" style="height:100%;">
                                            </div>
                                            <span class="item_cart"><?php echo $session['ExperiencesName']; ?></span>
                                        </td>
                                        ...
                                        <td class="options">
                                            <a href="{{ url('experiences/remove-item/'.$session['ExperiencesID']) }}"><i class=" icon-trash"></i></a>
                                            <a href="{{ url('experiences/'.$session['Slug']) }}"><i class="icon-edit"></i></a>
                                        </td>
                                    </tr>
                                    <?php
                                }
            ...
            <!--<div class="add_bottom_15"><small>* Prices for person.</small></div>-->
                    ...
                    <aside class="col-md-4">
                        <div class="box_style_1">
                            ...
                            <a class="btn_full" href="{{ url('experiences-payment') }}">Check out</a>
                ...
                echo '<center><h5 style="margin-bottom:200px;"><a href="' . url('experiences') . '">Continue Booking</a></h5></center>';
            }
            ?>
        </div><!--End container -->
