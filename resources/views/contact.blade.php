...
@section('content') 
<style>
.ad-box h3 {font-size: 16px;font-weight: 800;}
</style>
<section class="d-flex contact-banner bg-norepeat bg-center bg-cover" style="background:url({{ url('resources/assets/web') }}/img/banners/contact-bg.jpg);">
    <div class="container-fluid align-self-center">
        ...
        <div class="row justify-content-center">
            <div class="col-lg-6 align-self-center mtpx-94">
                <div class="row m-0">
                        <h1 class="font-weight-bold text-white">Hotel Addresses</h1>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="d-flex ad-box">
                            <p>
                                <a href="{{ $configuration->Facebook }}" target="_blankADDRESS
        "><span class="icon-facebook" style="color:#fff;"></span></a>
 ...
 <section class="contact-slider-area d-none">
