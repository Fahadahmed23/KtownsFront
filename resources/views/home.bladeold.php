...
<div class="col-lg-3">
<div class="">
<img title="{{ $client->Title }}" src="{{ url('public/uploads/website/clients/'.$client->Image) }}" style="margin:0 auto; height: 160px;">
</div>
</div>
<?php
                        }
