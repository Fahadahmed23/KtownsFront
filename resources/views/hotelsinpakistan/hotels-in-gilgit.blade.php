...
@section('title', "Hotels in Gilgit | Guest House In Gilgit | Ktown Rooms") 
@section('description', "Book a hotels in Gilgit, get the best hotels and guest house deals in Gilgit with the facilities of Free WiFi, free breakfast, AC, 32″ LED in a room.")
@section('content')
<section class="d-flex vancies-banner bg-norepeat bg-center bg-cover" style="background:url({{ url('resources/assets/web') }}/img/covers/gilgit-cover.jpg);">

    <div class="container align-self-center">
        <div class="row justify-content-center">
            <div class="col-lg-12">
                <h2 class="ban-heading">GILGIT TOP HOTELS
        ...
        <div class="row">
            ...
            <div class="col-lg-8">
                ...
                <div class="custom-heading mbpx-20">
                    <h3> <strong>Hotels</strong> In Gilgit
