...
<html>
    <head>
        ...
        <title>{{ $configuration->WebsiteTitle }} | Blog</title>
    ...
    <body class="hold-transition skin-blue sidebar-mini">
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <!-- Main content -->
                {!! Form::open([ 'url' => 'admin/blog/delete', 'id' => 'frm_list' ]) !!}
                            ...
                            <div class="box box-success">
                                <div class="box-header with-border">
                                    ...
                                    <div class="box-tools pull-right">
                                        <button type="button" class="btn btn-sm btn-primary" onClick="location.href = '{{ url('admin/blog/add') }}'"><i class="fa fa-plus"></i> Add New</button>
