...
<html>
    <head>
        ...
        <title>{{ $configuration->WebsiteTitle }} | Hotel Partner Request</title>
        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <h1>Hotel Partner Request</h1>
                    <ol class="breadcrumb">
                        <li><a href="{{ url('admin') }}"><i class="fa fa-dashboard"></i> Home</a></li>
                        <li><a href="{{ url('admin/partner-requests') }}">Hotel Partner Requests</a></li>
                            ...
                            <div class="box box-primary">
                                <div class="box-header with-border">
                                    ...
                                    <div class="box-tools pull-right">
                                        <button type="button" class="btn btn-sm btn-warning" onclick="location.href = '{{ url('admin/partner-requests') }}'"><i class="fa fa-times"></i> Back</button>
                                    </div>
                                </div>
                                <div class="box-body">
                                    <table class="table table-bordered">
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $Details->HotelName; ?></td>
                                        </tr>
                                        <tr>
                                            <th style="width:20%;">Email:</th>
                                            <td><?php echo $Details->EmailAddress; ?></td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            <th style="width:20%;">No. of Rooms:</th>
                                            <td><?php echo $Details->NoOfRooms; ?></td>
                                        </tr>
                                        <tr>
                                ...
                                <div class="box-footer">
                                    <div class="box-tools pull-right">
                                        <button type="button" class="btn btn-sm btn-warning hide" onclick="location.href = '{{ url('admin/partner-requests') }}'"><i class="fa fa-times"></i> Back</button>
                                    </div>
                                </div>
                            </div>
                        </div>
