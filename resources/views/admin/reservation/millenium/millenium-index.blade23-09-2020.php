        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <h1><i class="fa fa-edit"></i> Millenium Booking Lists</h1>
                    <ol class="breadcrumb">
                        <li><a href="javascript:void(0);"><i class="fa fa-dashboard"></i> Home</a></li>
                        <li class="active">Millenium Booking Lists</li>
                    </ol>
                </section>
                <!-- Main content -->
                {!! Form::open([ 'url' => 'admin/Millenium/reservation', 'id' => 'frm_list' ]) !!}
                        ...
                        <div class="col-xs-12">
                            <div class="box box-success">
                                <div class="box-header with-border">
                                    <h3 class="box-title">Millenium Booking Lists</h3>
                                    <div class="box-tools pull-right">
                                        ...
                                        <a style="margin: 0px 5px 0px 0px;" class="btn btn-primary trial" title="Listing" href="{{url('admin/millenium')}}" role="button"><i class="fa fa-list"></i><span class="hidden-md hidden-sm hidden-xs"> Millenium Room List</span></a>
