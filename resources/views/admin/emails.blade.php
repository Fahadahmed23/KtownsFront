...
<html>
    <head>
        ...
        <title>{{ $configuration->WebsiteTitle }} | Emails</title>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label for="SignupEmail">Signup Email <span class="mandatory">*</span></label>
                                                                {!! Form::text('SignupEmail', $emails->SignupEmail, ['class' => 'form-control', 'id' => 'SignupEmail']) !!}
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label for="BookingEmail">BookingEmail <span class="mandatory">*</span></label>
                                                                {!! Form::text('BookingEmail', $emails->BookingEmail, ['class' => 'form-control', 'id' => 'BookingEmail']) !!}
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label for="AdminEmail">Admin Email <span class="mandatory">*</span></label>
                                                                {!! Form::text('AdminEmail', $emails->AdminEmail, ['class' => 'form-control', 'id' => 'SignupEmail']) !!}
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label for="AdminPhone">Admin Phone <span class="mandatory">*</span></label>
                                                                {!! Form::text('AdminPhone', $emails->AdminPhone, ['class' => 'form-control', 'id' => 'AdminPhone']) !!}
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
