...
<html>
    <head>
        ...
        <title>{{ $configuration->WebsiteTitle }} | Corporate Client Requests</title>
        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <h1><i class="fa fa-edit"></i> Corporate Partner Requests</h1>
                    <ol class="breadcrumb">
                        <li><a href="{{ url('admin') }}"><i class="fa fa-dashboard"></i> Home</a></li>
                        <li class="active">Corporate Partner Requests</li>
                    </ol>
                </section>
                <!-- Main content -->
                {!! Form::open([ 'url' => 'admin/corporate-clients/delete', 'id' => 'frm_list' ]) !!}
                <section class="content">
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="box box-success">
                                <div class="box-header with-border">
                                    <h3 class="box-title">Corporate Partner Requests</h3>
                                    <div class="box-tools pull-right">
<!--                                        <button type="button" class="btn btn-sm btn-primary" onClick="location.href = '{{ url('admin/partner-requests/add') }}'"><i class="fa fa-plus"></i> Add New</button>-->
        ...
        <script language="javascript">
                                            ...
                                            function doDelete()
                                            {
                                                if (checkboxes.filter(':checked').length > 0)
                                                {
                                                    ...
                                                    message_box("Confirm", "This will delete all selected requests.<br>Are you sure?", "confirm", ok, null);
                                                } else
                                                {
                                                    message_box("Alert", "Please select request to delete", "alert", null, null);
                                                }
                                            }
        </script>
    </body>
