...
<html>
    <head>
        ...
        <title>{{ $configuration->WebsiteTitle }} | Add New Hotel Image</title>
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li><a href="{{ url('admin/hotel-images/'.$HotelID) }}">Hotel Images</a></li>
                ...
                <section class="content">
                    {!! Form::open([ 'url' => 'admin/hotel-images/add/'.$HotelID, 'files' => true]) !!}
                    <div class="row">
                        <div class="col-md-12">
