            ...
            <h4 class="mb-15"><img src="{{ url('resources/assets/web') }}/img/sb-icon.png" alt="*" class="fl-icon">
                ...
                <ul class="list-round">
                    ...
                    $keyword = \Request::get('t');
                        ...
                        <li>
                            <a class="highlight"  href="hotels?t=<?php echo $hotel_type->HotelTypeName; ?>"><?php echo $hotel_type->HotelTypeName; ?></a>
                        </li>
                         @else
                         <li>
                            <a href="hotels?t=<?php echo $hotel_type->HotelTypeName; ?>"><?php echo $hotel_type->HotelTypeName; ?></a>
                        </li>
                         @endif
