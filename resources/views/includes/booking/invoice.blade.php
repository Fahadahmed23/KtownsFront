...
<body>
    ...
    <?php if(isset($email)) { ?>
        ...
        <ol>
            <li>KTown Rooms and Homes ({{$hotel[0]->Address2}}) is expecting you on {{$hotel[0]->CheckInDate}} at 14:00 - 15:00.</li>
            <li>Your payment will be handled by KTown Rooms and Homes ({{$hotel[0]->HotelName}}).</li>
        </ol>
    <?php } ?>
        <div class="paddingDiv">
            <div class="logoContainer">
                <div style="">
                    <img class="logo" src="{{ url('resources/assets/web/img/logo.png') }}" />
                </div>
            </div>
            ...
            <div class="">
                <table class="table" style="border: none !important; width: 100%;">
                    <tr style="border: none !important;">
                        <td class="hotelName"><b style="width: 100px; display: inline-block;font-size: 15px;">Hotel Name:</b> {{ $hotel[0]->HotelName }}<br><b style="width: 100px; display: inline-block;font-size: 15px;">Hotel Address:</b>{{$hotel[0]->Address2}}
                        </td>
                ...
                <div class="">
                    <a href="{{$Booking[0]->map_url}}" target="_blank">
                    <img  src="{{ url('public/uploads/website/maps') . '/' . str_replace(' ','%20',$Booking[0]->map_image)}}" alt="" style="width: 100%;max-width: 100%;object-fit: unset"></a>
                </div>
