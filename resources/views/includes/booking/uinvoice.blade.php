                ...
                <div class="col-xs-6">
                    ...
                    <table>
                        <tr>
                            ...
                            <td>FL-36 3rd Image Tower, Block B, Gulshan-E-Jamal, Main Rashid Minhas Road, Opp Nueplex, Karachi</td>
                        </tr>
                        <tr>
                            <td><b>Phone No.:</b></td>
                            <td>+92(311) 1222 418, +92(213) 468 8335</td>
                        </tr>
                        <tr>
                            <td><b>Website:</b></td>
                ...
                <div class="col-xs-12">
                    <table class="table no-border">
                        <tr class="no-border width50">
                            <td class="no-border"><b style="width: 100px; display: inline-block;">Hotel Name:</b> {{ $hotel[0]->HotelName }}<br><b style="width: 100px; display: inline-block;">Address:</b> {{ $hotel[0]->Address.' '.$hotel[0]->Address2 }}</td>
                            <td class="no-border" style="font-size:11px;"><div class="custom-helpline">Help Line No.: 	+92(311) 1222 418, +92(213) 468 8335</div></td>
                        </tr>
                    </table>
                    <hr />
                    <table class="table table-bordered width25">
                        ...
                        <tr style="background: #f5f5f5;">
                            <td class="text-center">INV-{{ $Booking[0]->BookingID }}</td>
            ...
            <div class="row">
                <div class="col-xs-12">
                    <table class="table table-bordered" style="margin-bottom:2px;">
                        ...
                        <tr>
                            <td class="no-border" colspan="5">All Total:</td>
