...
<a class="fontlato" href="mailto:{{ $emails->SupportEmail }}">{{ $emails->SupportEmail }}</a>
...
<div class="col-md-3">
			...
			<a href="https://wa.me/92{{ substr($configuration->WhatsApp, 1) }}?text=I'm%20interested%20in%20your%20Ktownrooms%20for%20Booking"><i class="fa fa-whatsapp mblwhtsap "></i></a>
			
			<!-- <a href="https://web.whatsapp.com/send?phone=923453382192&text=I%27m+interested+in+your+Ktownrooms+for+Booking&source&data&app_absent"><i class="fa fa-whatsapp webwhtsap"></i></a> -->
...
<div class="hotel-locations hidden-sm-down  ">
		...
		<a href="#">Hotels in Multan</a>
		<a href="#">Hotels in Gwadar</a>
		<a href="#">Hotels in Sukkur</a>
		<a href="#">Hotels in Ziarat</a>
		<a href="#">Hotels in Larkana</a>
		<a href="#">Hotels in Muzaffarabad</a>
		<a href="#">Hotels in Neelum Valley</a>
		<a href="#">Hotels in Peshawar</a>
		<a href="#">Hotels in Quetta</a>
		<a href="#">Hotels in Malam Jabba</a>
		<a href="#">Hotels in Rawalpindi</a>
		<a href="#">Hotels in Hunza</a>
		<a href="#">Hotels in Skardu</a>
		<a href="#">Hotels in Kalam</a>
		<a href="#">Hotels in Abbottabad</a>
		<a href="#">Hotels in Aliabad</a>
		<a href="#">Hotels in Arang Kel</a>
		<a href="#">Hotels in Nathia Gali</a>
		<a href="#">Hotels in Shogran</a>
		<a href="#">Hotels in Gilgit</a>
		<a href="#">Hotels in Chitral</a>
		<a href="#">Hotels in Attock</a>
		<a href="#">Hotels in Mansehra</a>
		<a href="#">Hotels in Bagh</a>
		<a href="#">Hotels in Rawalakot</a>
		<a href="#">Hotels in Bahawalpur</a>
		<a href="#">Hotels in Balakot</a>
		<a href="#">Hotels in Gujranwala</a>
		<a href="#">Hotels in Ayubia</a>
		<a href="#">Hotels in Kotli</a>
		<a href="#">Hotels in Mirpur</a>
		<a href="#">Hotels in Sargodha</a>
		<a href="#">Hotels in Sialkot</a>
		<a href="#">Hotels in Faisalabad</a>
		<a href="#">Hotels in Saidu Sharif</a>
		<a href="#">Hotels in Mingora</a>
		<a href="#">Hotels in Chilas</a>
		<a href="#">Hotels in Dera Ismail Khan</a>
		<a href="#">Hotels in Gorakh Hill</a>
		<a href="#">Hotels in Kalash Valley</a>
</div>
<div class="hotel-locations hidden-sm-down hide ">
...
<div class="whtspsIcon">
	<a target="_blank" href="https://wa.me/92{{ substr($configuration->WhatsApp, 1) }}?text=I'm%20interested%20in%20your%20Ktownrooms%20for%20Booking" class="whatsapp btn "><i class="fa fa-whatsapp"></i></a>
...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css?rnd=<?php echo uniqid() ?>">
<link href="https://fonts.googleapis.com/css?family=Montserrat:200,300,400,500,600,700,800,900&rnd=<?php echo uniqid() ?>" rel="stylesheet">
<link href="https://fonts.googleapis.com/css?family=Lato:300,400,700,900&rnd=<?php echo uniqid() ?>" rel="stylesheet">
<link href="https://fonts.googleapis.com/css?family=Quicksand:300,400,500,700&rnd=<?php echo uniqid() ?>" rel="stylesheet">

<link rel="stylesheet" href="https://ajax.googleapis.com/ajax/libs/jqueryui/1.8.16/themes/base/jquery-ui.css?rnd=<?php echo uniqid() ?>" type="text/css" media="all">
<script src="https://cdn.jsdelivr.net/npm/lozad/dist/lozad.min.js?rnd=<?php echo uniqid() ?>"></script>
