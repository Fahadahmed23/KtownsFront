<div class="col-lg-4">
    ...
    <div class="info-bx text-center hidden-sm-down">
        ...
        <p class="ff-sec fspx-12"><span class="icon-phone mr-1"></span>{{ $configuration->Contact1 }}</p>
        <p class="ff-sec fspx-12"><span class="icon-phone mr-1"></span>{{ $configuration->Contact2 }}</p>
        <p class="fspx-12"><span class="icon-envelope2 mr-1"></span> {{ $emails->SupportEmail }}</p>
    </div>
</div>  