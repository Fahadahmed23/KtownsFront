                ...
                <div class="form-sec">
                    ...
                    <div class="filterform" >
                        ...
                        <div class="dcheck">
                            ...
                            <input class="toDate date" type="text" name="toDate" id="toDate" value="<?php  echo $toDate; ?>">
                        </div>
                        ...
                        <div class="dcheck">
                            ...
                            <input class="fromDate date" type="text" name="fromDate" id="fromDate" value="<?php echo $fromDate; ?>">
                        </div>
                        ...
                        <div class="dcheck">
                            ...
                            <input class="adults" type="number" name="adults" id="adults" value="{{Session::get('adults')[0]}}">
                        </div>
                        <?php if (empty($rooms)) {
                               $rooms = "";
                            }  ?>
                        <div class="dcheck">
                            ...
                            <input class="rooms" type="number" name="rooms" id="rooms" value="{{Session::get('rooms')[0]}}">
                        </div>
